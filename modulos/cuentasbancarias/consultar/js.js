...
function comprobarReglas(){
	...
	if(recuperarCookie("campoOrdenCuentasbancarias")!=null){
		campoOrden=recuperarCookie("campoOrdenCuentasbancarias");
	...
	if(recuperarCookie("cantidadamostrarCuentasbancarias")!=null){
		cantidadamostrar=recuperarCookie("cantidadamostrarCuentasbancarias");
	...
	if(recuperarCookie("ordenCuentasbancarias")=="asc"){
		orden="ASC"
		$('#asc').attr('checked', true);
		$('#desc').attr('checked', false);
	}else if(recuperarCookie("ordenCuentasbancarias")=="desc"){
		orden="DESC"
	...
	if(recuperarCookie("mostrarCuentaCuentasbancarias")=="si"){
		$('.Ccuenta').show();
		$('#CheckCuenta').attr('checked', true);
	}else if(recuperarCookie("mostrarCuentaCuentasbancarias")=="no"){
		$('.Ccuenta').hide();
		$('#CheckCuenta').attr('checked', false);
	}
	//Mostrar u Ocultar Banco
	if(recuperarCookie("mostrarBancoCuentasbancarias")=="si"){
		$('.Cbanco').show();
		$('#CheckBanco').attr('checked', true);
	}else if(recuperarCookie("mostrarBancoCuentasbancarias")=="no"){
		$('.Cbanco').hide();
		$('#CheckBanco').attr('checked', false);
	}
	//Mostrar u Ocultar Saldo
	if(recuperarCookie("mostrarSaldoCuentasbancarias")=="si"){
		$('.Csaldo').show();
		$('#CheckSaldo').attr('checked', true);
	}else if(recuperarCookie("mostrarSaldoCuentasbancarias")=="no"){
		$('.Csaldo').hide();
		$('#CheckSaldo').attr('checked', false);
	}
	//Mostrar u Ocultar Composicion
	if(recuperarCookie("mostrarComposicionCuentasbancarias")=="si"){
		$('.Ccomposicion').show();
		$('#CheckComposicion').attr('checked', true);
	}
	if(recuperarCookie("mostrarComposicionCuentasbancarias")=="no"){
		$('.Ccomposicion').hide();
		$('#CheckComposicion').attr('checked', false);
	}
	
	//Elegir el tipo de vista
	if(recuperarCookie("tipoVistaCuentasbancarias")=="tabla"){
		$('.tipoLista').show();
		$('.tipoTabla').hide();
		tipoVista="tabla";
	}else{
	...
	$( ".tipoTabla" ).click(function() {
    	crearCookie("tipoVistaCuentasbancarias", "tabla");
		tipoVista="tabla";
		$(".tipoLista").show();
		$(".tipoTabla").hide();
	...
	$( ".tipoLista" ).click(function() {
    	crearCookie("tipoVistaCuentasbancarias", "lista");
		tipoVista="lista";
		$(".tipoLista").hide();
		$(".tipoTabla").show();
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
...
$(document).ready(function() {
	...
	$("#campoOrden").change(function(){
		...
		crearCookie("campoOrdenCuentasbancarias", campoOrden);
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
	});
	$("#cantidadamostrar").change(function(){
		cantidadamostrar = this.value;
		crearCookie("cantidadamostrarCuentasbancarias", cantidadamostrar);
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
	});
	$( "#asc" ).click(function() {
    	if ($( "#asc" ).is(':checked')){
			crearCookie("ordenCuentasbancarias", "asc");
			orden="ASC"
			load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
		}
	});
	$( "#desc" ).click(function() {
    	if ($( "#desc" ).is(':checked')){
			crearCookie("ordenCuentasbancarias", "desc");
			orden="DESC"
			load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
		}
	});
	$( "#CheckCuenta" ).click(function() {
    	if ($( "#CheckCuenta" ).is(':checked')){
			crearCookie("mostrarCuentaCuentasbancarias", "si");
			$('.Ccuenta').show();
		}else{
			crearCookie("mostrarCuentaCuentasbancarias", "no");
			$('.Ccuenta').hide();
		}	
	});
	$( "#CheckBanco" ).click(function() {
    	if ($( "#CheckBanco" ).is(':checked')){
			crearCookie("mostrarBancoCuentasbancarias", "si");
			$('.Cbanco').show();
		}else{
			crearCookie("mostrarBancoCuentasbancarias", "no");
			$('.Cbanco').hide();
		}	
	});
	$( "#CheckSaldo" ).click(function() {
    	if ($( "#CheckSaldo" ).is(':checked')){
			crearCookie("mostrarSaldoCuentasbancarias", "si");
			$('.Csaldo').show();
		}else{
			crearCookie("mostrarSaldoCuentasbancarias", "no");
			$('.Csaldo').hide();
		}	
	});
	$( "#CheckComposicion" ).click(function() {
    	if ($( "#CheckComposicion" ).is(':checked')){
			crearCookie("mostrarComposicionCuentasbancarias", "si");
			$('.Ccomposicion').show();
		}else{
			crearCookie("mostrarComposicionCuentasbancarias", "no");
			$('.Ccomposicion').hide();
		}
	});
