		...
		<ul>
			...
			<li>
				<div class="tituloMenu">
					<div id="labelMenu">cuentasbancarias</div>
				</div>
			</li>
			<?php
			/////PERMISOS////////////////
			...
			<li>
				...
				<div id="labelMenu">Nuevo cuentasbancarias</div>
				</a>
			</li>
			<?php }?>
			...
			<li>
				...
				<div id="labelMenu">Consultar cuentasbancarias</div>
				</a>
			</li>
			<?php }?>
			<?php
			...
			<li>
				...
				<div id="labelMenu">Papelera de cuentasbancarias</div>
				</a>
			</li>
			<?php }?>
