    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Cuentas Bancarias<small>Modificar registro</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Modificar cuentasbancarias</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['cuentasbancarias']['modificar']) or  !isset($_SESSION['permisos']['cuentasbancarias']['acceso'])){
            ...
            <div class="box box-info" style="border-color:#b870b8">
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-3">
                    	<span id="Vbanco">
                        <input value="<?php echo $banco; ?>" name="banco" type="text" class="form-control" id="cbanco" />
            			<span class="textfieldMaxCharsMsg">Se ha superado el número máximo de caracteres.</span>
					<span class="textfieldMinCharsMsg">No se cumple el mínimo de caracteres requerido.</span>
						<span class="textfieldRequiredMsg">Se necesita un valor.</span>
					</span>
                ...
                <div class="box-footer">
				  <input name="idcuenta" type="hidden" id="cidcuenta" value="<?php echo $id;?>"/>
