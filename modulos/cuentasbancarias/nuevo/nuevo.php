  ...
  <body class="sidebar-mini <?php include("../../../componentes/skin.php");?>">
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Cuentas Bancarias<small>Nuevo registro</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Nuevo cuentasbancarias</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['cuentasbancarias']['guardar']) or  !isset($_SESSION['permisos']['cuentasbancarias']['acceso'])){
	...
	/////FIN  DE PERMISOS////////
			...
			<?php include("../../../componentes/avisos.php");?>
          	...
          	<!-- Horizontal Form -->
            <div class="box box-info" style="border-color:#b870b8">
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-3">
                    	<span id="Vcuenta">
                        <input value="" name="cuenta" type="text" class="form-control" id="ccuenta" />
				...
				<div class="form-group ">
                    <label for="cbanco" class="col-sm-2 control-label">Banco:</label>
                    <div class="col-sm-3">
                    	<span id="Vbanco">
                        <input value="" name="banco" type="text" class="form-control" id="cbanco" />
            			<span class="textfieldMaxCharsMsg">Se ha superado el número máximo de caracteres.</span>
					<span class="textfieldMinCharsMsg">No se cumple el mínimo de caracteres requerido.</span>
						<span class="textfieldRequiredMsg">Se necesita un valor.</span>
					</span>
              ...
              <div id="loading" class="overlay" style="display:none">
  					<i class="fa fa-cog fa-spin" style="color:#b870b8"></i>
			  </div>
...
var sprytextfield1 = new Spry.Widget.ValidationTextField("Vcuenta", "none", {validateOn:["blur"],  maxChars:30,  minChars:1});
				var sprytextfield2 = new Spry.Widget.ValidationTextField("Vbanco", "none", {validateOn:["blur"],  maxChars:100,  minChars:1});
