	...
	include("../../../componentes/herramientasconsultar.php"); ?>
		...
		<li class="dropdown btn-defaul border-right" style="background:#F4F4F4;" title="Visualización y ordenamiento">
          ...
          <ul class="dropdown-menu dropdown-menu-form" style="min-width:250px;;">
			...
			<li><a><input id="CheckPuesto" name="kpuesto" value="si" checked="checked" type="checkbox"/><label for="CheckPuesto">&nbsp;&nbsp;Puesto</label></a></li>
			
			<li><a><input id="CheckDomicilio" name="kdomicilio" value="si" checked="checked" type="checkbox"/><label for="CheckDomicilio">&nbsp;&nbsp;Domicilio</label></a></li>
			
			<li><a><input id="CheckTelefono" name="ktelefono" value="si" checked="checked" type="checkbox"/><label for="CheckTelefono">&nbsp;&nbsp;Teléfono</label></a></li>
			
			<li><a><input id="CheckEmail" name="kemail" value="si" checked="checked" type="checkbox"/><label for="CheckEmail">&nbsp;&nbsp;E-mail</label></a></li>
