...
<body class="sidebar-mini <?php include("../../../componentes/skin.php");?>">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="#">Consultar sucursal</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['sucursales']['consultar']) or  !isset($_SESSION['permisos']['sucursales']['acceso'])){
	...
	/////FIN  DE PERMISOS////////
        	...
        	<?php include("../../../componentes/avisos.php");?>
          	<!-- box -->
            <div class="box box-info" style="border-color:#e03452">
                ...
                <div id="loading" class="overlay">
  					<i class="fa fa-cog fa-spin" style="color:#e03452"></i>
			  	</div>
