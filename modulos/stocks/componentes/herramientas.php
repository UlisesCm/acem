          ...
          <ul class="dropdown-menu dropdown-menu-form" style="min-width:250px;;">
            ...
            <li><a>
            	<select id="campoOrden" class="form-control input-sm">
									...
									<option value="stockmaximo">Stock máximo</option>
                </select>
                </a>
    		</li>
            ...
            <li><span class="titulo-herramientas">Mostrar / Ocultar campos</span></li>
				...
				<li><a><input id="CheckIdproducto" name="kidproducto" value="si" checked="checked" type="checkbox"/><label for="CheckIdproducto">&nbsp;&nbsp;Idproducto</label></a></li>
			
				<li><a><input id="CheckFechainicio" name="kfechainicio" value="si" checked="checked" type="checkbox"/><label for="CheckFechainicio">&nbsp;&nbsp;Fecha inicio</label></a></li>
			
				<li><a><input id="CheckFechafin" name="kfechafin" value="si" checked="checked" type="checkbox"/><label for="CheckFechafin">&nbsp;&nbsp;Fecha fin</label></a></li>
			
				<li><a><input id="CheckStockminimo" name="kstockminimo" value="si" checked="checked" type="checkbox"/><label for="CheckStockminimo">&nbsp;&nbsp;Stock mínimo</label></a></li>
			
				<li><a><input id="CheckReserva" name="kreserva" value="si" checked="checked" type="checkbox"/><label for="CheckReserva">&nbsp;&nbsp;Reserva</label></a></li>
			
				<li><a><input id="CheckStockmaximo" name="kstockmaximo" value="si" checked="checked" type="checkbox"/><label for="CheckStockmaximo">&nbsp;&nbsp;Stock máximo</label></a></li>
