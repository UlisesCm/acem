		...
		<li class="dropdown btn-defaul border-right" style="background:#F4F4F4;" title="Visualización y ordenamiento">
          ...
          <ul class="dropdown-menu dropdown-menu-form" style="min-width:250px;;">
            ...
            <li><span class="titulo-herramientas">Mostrar / Ocultar campos</span></li>
				...
				<li><a><input id="CheckIdcuentaprincipal" name="kidcuentaprincipal" value="si" checked="checked" type="checkbox"/><label for="CheckIdcuentaprincipal">&nbsp;&nbsp;Cuenta principal</label></a></li>
			
				<li><a><input id="CheckIdcuentasecundaria" name="kidcuentasecundaria" value="si" checked="checked" type="checkbox"/><label for="CheckIdcuentasecundaria">&nbsp;&nbsp;Cuenta secundaria</label></a></li>
				...
				<li><a><input id="CheckIdproveedor" name="kidproveedor" value="si" checked="checked" type="checkbox"/><label for="CheckIdproveedor">&nbsp;&nbsp;Proveedor</label></a></li>
