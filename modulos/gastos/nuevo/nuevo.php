...
<body class="sidebar-mini <?php include("../../../componentes/skin.php"); ?>">
  ...
  <script type="text/javascript">
    var sprytextfield1 = new Spry.Widget.ValidationTextField("Vdescripcion", "none", {
      validateOn: ["blur"],
      maxChars: 200,
      minChars: 1
    });
    var sprytextfield2 = new Spry.Widget.ValidationTextField("Vcheque", "none", {
      validateOn: ["blur"],
      maxChars: 10,
      minChars: 1
    });
    var sprytextfield3 = new Spry.Widget.ValidationTextField("Vbeneficiario", "none", {
      validateOn: ["blur"],
      maxChars: 150,
      minChars: 1
    });
