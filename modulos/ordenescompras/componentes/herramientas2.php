...
if ($herramientas=="nuevo"){ ?>
    <li class="btn-default border-right tipoDescripcion" title="Búsqueda por descripción" style="display:none"><a href="#"><i class="fa fa-search"></i> <i class="fa fa-font"></i><span class="visible-xs-inline">&nbsp;&nbsp;Busca productos por descripción</span></a></li>
    <li class="btn-default border-right tipoCB" title="Búsqueda por Código de Barras" style="display:none"><a href="#"><i class="fa fa-search"></i> <i class="fa fa-barcode"></i><span class="visible-xs-inline">&nbsp;&nbsp;Busca productos por código de barras</span></a></li>
	<?php
