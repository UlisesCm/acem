    ...
    <div class="wrapper s">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Ordenes de Compra<small> Consulta</small>
          </h1>
          <ol class="breadcrumb">
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['compras']['consultar']) or  !isset($_SESSION['permisos']['compras']['acceso'])){
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
                <div class="box-body">
                    ...
                    <div class='row' style="padding-left:20px; padding-right:20px; padding-bottom:0px; margin-bottom:0px;"><!-- /.Row -->
                    	...
                    	<div class='col-sm-2'>
                            <div class="form-group">
                            	<label for="cfechainicio">Ordenes de:</label>
                            	<input value="<?php 
								$fecha = date('Y-m-d');
								$nuevafecha = strtotime ( '-1 month' , strtotime ( $fecha ) ) ;
								$nuevafecha = date ( 'Y-m-d' , $nuevafecha );
								echo $nuevafecha; ?>" name="fechainicio" type="date" required class="form-control" id="cfechainicio" />
                            </div>
                         </div>
                        <div class='col-sm-2'>
                            <div class="form-group">
                        ...
                        <div class='col-sm-2'>
                            <div class="form-group">
                                ...
                                <select id="cestado" name="estado" class="form-control">
                                	<option value="Autorizada para recepcion">AUTORIZADAS PARA RECEPCION</option>
                        ...
                        <div class='col-sm-2'>
                            <div class="form-group">
                            	<label for="idproveedor_ajax">Prveedor:</label>
