...
$Ocursos=new Cursos;
$resultado=$Ocursos->mostrar($campoOrden, $orden, $inicial, $cantidadamostrar, $busqueda, $papelera);
        		...
        		<td>
					...
					?>
						...
						?>
							...
							<?php }else{ ?>
								<a class="btn btn-danger btn-xs" title="Eliminar" onclick="(eliminarIndividual(<?php echo $filas['idcurso'] ?>))"><li class="fa fa-trash"></li></a>
							<?php }?>
						<?php 
						}else{ ?>
							<a class="btn btn-danger btn-xs disabled"><i class="fa fa-trash-o"></i></a>
					...
					<?php 
							...
							<a class="btn btn-primary btn-xs" title="Restaurar Registro" onclick="(restaurarIndividual(<?php echo $filas['idcurso'] ?>))"><li class="fa fa-recycle"></li></a>
					<?php
					}
					?>
                </td>
