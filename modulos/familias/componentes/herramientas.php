          ...
          <ul class="dropdown-menu dropdown-menu-form" style="min-width:250px;;">
            ...
            <li><a>
            	<select id="campoOrden" class="form-control input-sm">
									<option value="idfamilia">ID</option>
									<option value="nombre">Nombre</option>
									<option value="mostrarendescripcion">Mostrar en descripción</option>
									<option value="nombredescripcion">Nombre descripción</option>
									<option value="prefijocodigo">Prefijo código</option>
									<option value="idfamiliamadre">Familia madre</option>
                </select>
                </a>
    		</li>
            ...
            <li><span class="titulo-herramientas">Mostrar / Ocultar campos</span></li>
				...
				<li><a><input id="CheckIdfamilia" name="kidfamilia" value="si" checked="checked" type="checkbox"/><label for="CheckIdfamilia">&nbsp;&nbsp;ID</label></a></li>
			
				<li><a><input id="CheckNombre" name="knombre" value="si" checked="checked" type="checkbox"/><label for="CheckNombre">&nbsp;&nbsp;Nombre</label></a></li>
			
				<li><a><input id="CheckMostrarendescripcion" name="kmostrarendescripcion" value="si" checked="checked" type="checkbox"/><label for="CheckMostrarendescripcion">&nbsp;&nbsp;Mostrar en descripción</label></a></li>
			
				<li><a><input id="CheckNombredescripcion" name="knombredescripcion" value="si" checked="checked" type="checkbox"/><label for="CheckNombredescripcion">&nbsp;&nbsp;Nombre descripcion</label></a></li>
			
				<li><a><input id="CheckPrefijocodigo" name="kprefijocodigo" value="si" checked="checked" type="checkbox"/><label for="CheckPrefijocodigo">&nbsp;&nbsp;Prefijo código</label></a></li>
			
				<li><a><input id="CheckIdfamiliamadre" name="kidfamiliamadre" value="si" checked="checked" type="checkbox"/><label for="CheckIdfamiliamadre">&nbsp;&nbsp;Familia madre</label></a></li>
