...
if($validacion){
	$resultado=$Ofamilia->actualizar($nombre,$mostrarendescripcion,$nombredescripcion,$prefijocodigo,$camposrequeridos,$idfamiliamadre,$estatus, $idfamilia);
	if($resultado=="exito"){
	...
	if($resultado=="fracasoFamilias"){
		$mensaje="fracaso@Operaci&oacute;n fallida@No puede asignar como familia madre a la misma familia";
	}
