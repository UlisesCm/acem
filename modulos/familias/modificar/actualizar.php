...
<html>
  <head>
    ...
    <script><?php echo "var idfamiliaSeleccionada='$idfamiliamadre';";?></script>
    <script><?php echo "var idfamilia='$id';";?></script>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Familia<small>Modificar registro</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Modificar familia</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['familias']['modificar']) or  !isset($_SESSION['permisos']['familias']['acceso'])){
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-10">
                    	<label>
							...
							?>
                  			<input id="cmostrarendescripcion" type="checkbox" name="mostrarendescripcion" value="si" <?php echo $checked; ?>>
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input value="<?php echo $nombredescripcion; ?>" name="nombredescripcion" type="text" class="form-control" id="cnombredescripcion" />
                ...
                <div class="form-group ">
                    ...
                    <div class="col-sm-5">
						<input value="<?php echo $idfamiliamadre; ?>" name="idfamiliamadre" type="hidden" class="normal" id="cidfamiliamadre" style="width:50px;"/>
						<input value="" name="consultaidfamiliamadre" type="hidden" class="normal" id="consultaidfamiliamadre" style="width:100px;"/>
                        <div class="input-group input-group-sm">
                        	<input value="<?php echo $autoidfamiliamadre; ?>" name="autoidfamiliamadre" type="text" class="form-control" id="autoidfamiliamadre" />
				...
				<div class="form-group hide">
                    ...
                    <div class="col-sm-5">
                        <input value="<?php echo $camposrequeridos; ?>" name="camposrequeridos" type="text" class="form-control" id="ccamposrequeridos" />
                    </div>
                </div>
                ...
                <div class="box-footer">
				  <input name="idfamilia" type="hidden" id="cidfamilia" value="<?php echo $id;?>"/>
