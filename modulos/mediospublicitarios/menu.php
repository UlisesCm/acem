		...
		<ul>
			...
			<li>
				<div class="tituloMenu">
					<div id="labelMenu">mediospublicitarios</div>
				</div>
			</li>
			<?php
			/////PERMISOS////////////////
			...
			<li>
				...
				<div id="labelMenu">Nuevo mediopublicitario</div>
				</a>
			</li>
			<?php }?>
			...
			<li>
				...
				<div id="labelMenu">Consultar mediospublicitarios</div>
				</a>
			</li>
			<?php }?>
			<?php
			...
			<li>
				...
				<div id="labelMenu">Papelera de mediospublicitarios</div>
				</a>
			</li>
			<?php }?>
