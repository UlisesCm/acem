<?php 
	...
	$resultado=$Ofacturacion->consultaGeneral("WHERE (foliointerno LIKE '%$buscar%' OR receptor LIKE '%$buscar%') AND receptor='$receptor' ORDER BY fecha DESC, foliointerno DESC LIMIT 20 ");
	$con=0;
	$return_arr = array();
