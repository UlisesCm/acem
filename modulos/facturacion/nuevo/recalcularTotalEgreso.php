...
$arregloIdproducto=descomponerArreglo(5,0,$lista);
$arregloCantidad=descomponerArreglo(5,1,$lista);
$arregloPrecio=descomponerArreglo(5,2,$lista);
$arregloDescuento=descomponerArreglo(5,3,$lista);
...
while ($con < count($arregloIdproducto)){
	...
	$totalIVAtrasladado=($cantidad*$preciounitario)*0.16;
	$labelIVAtrasladado="";
