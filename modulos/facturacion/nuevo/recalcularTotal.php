...
$arregloCantidad=descomponerArreglo(6,1,$lista);
$arregloPrecio=descomponerArreglo(6,2,$lista);
$arregloDescuento=descomponerArreglo(6,3,$lista);
$arregloIdreferencia=descomponerArreglo(6,4,$lista);
