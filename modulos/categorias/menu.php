		...
		<ul>
			...
			<li>
				<div class="tituloMenu">
					<div id="labelMenu">categorias</div>
				</div>
			</li>
			<?php
			/////PERMISOS////////////////
			...
			<li>
				...
				<div id="labelMenu">Nuevo categoria</div>
				</a>
			</li>
			<?php }?>
			...
			<li>
				...
				<div id="labelMenu">Consultar categorias</div>
				</a>
			</li>
			<?php }?>
			<?php
			...
			<li>
				...
				<div id="labelMenu">Papelera de categorias</div>
				</a>
			</li>
			<?php }?>
