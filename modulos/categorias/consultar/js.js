...
function comprobarReglas(){
	...
	if(recuperarCookie("campoOrdenCategoria")!=null){
		campoOrden=recuperarCookie("campoOrdenCategoria");
	...
	if(recuperarCookie("cantidadamostrarCategoria")!=null){
		cantidadamostrar=recuperarCookie("cantidadamostrarCategoria");
	...
	if(recuperarCookie("ordenCategoria")=="asc"){
		orden="ASC"
		$('#asc').attr('checked', true);
		$('#desc').attr('checked', false);
	}else if(recuperarCookie("ordenCategoria")=="desc"){
		orden="DESC"
	...
	if(recuperarCookie("mostrarIdcategoriaCategoria")=="si"){
		$('.Cidcategoria').show();
		$('#CheckIdcategoria').attr('checked', true);
	}else if(recuperarCookie("mostrarIdcategoriaCategoria")=="no"){
		$('.Cidcategoria').hide();
		$('#CheckIdcategoria').attr('checked', false);
	}
	//Mostrar u Ocultar Codigo
	if(recuperarCookie("mostrarCodigoCategoria")=="si"){
		$('.Ccodigo').show();
		$('#CheckCodigo').attr('checked', true);
	}else if(recuperarCookie("mostrarCodigoCategoria")=="no"){
		$('.Ccodigo').hide();
		$('#CheckCodigo').attr('checked', false);
	}
	//Mostrar u Ocultar Nombre
	if(recuperarCookie("mostrarNombreCategoria")=="si"){
		$('.Cnombre').show();
		$('#CheckNombre').attr('checked', true);
	}else if(recuperarCookie("mostrarNombreCategoria")=="no"){
		$('.Cnombre').hide();
		$('#CheckNombre').attr('checked', false);
	}
	//Mostrar u Ocultar Composicion
	if(recuperarCookie("mostrarComposicionCategoria")=="si"){
		$('.Ccomposicion').show();
		$('#CheckComposicion').attr('checked', true);
	}
	if(recuperarCookie("mostrarComposicionCategoria")=="no"){
		$('.Ccomposicion').hide();
		$('#CheckComposicion').attr('checked', false);
	}
	
	//Elegir el tipo de vista
	if(recuperarCookie("tipoVistaCategoria")=="tabla"){
		$('.tipoLista').show();
		$('.tipoTabla').hide();
		tipoVista="tabla";
	}else{
	...
	$( ".tipoTabla" ).click(function() {
    	crearCookie("tipoVistaCategoria", "tabla");
		tipoVista="tabla";
		$(".tipoLista").show();
		$(".tipoTabla").hide();
	...
	$( ".tipoLista" ).click(function() {
    	crearCookie("tipoVistaCategoria", "lista");
		tipoVista="lista";
		$(".tipoLista").hide();
		$(".tipoTabla").show();
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
...
$(document).ready(function() {
	...
	$("#campoOrden").change(function(){
		...
		crearCookie("campoOrdenCategoria", campoOrden);
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
	});
	$("#cantidadamostrar").change(function(){
		cantidadamostrar = this.value;
		crearCookie("cantidadamostrarCategoria", cantidadamostrar);
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
	});
	$( "#asc" ).click(function() {
    	if ($( "#asc" ).is(':checked')){
			crearCookie("ordenCategoria", "asc");
			orden="ASC"
			load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
		}
	});
	$( "#desc" ).click(function() {
    	if ($( "#desc" ).is(':checked')){
			crearCookie("ordenCategoria", "desc");
			orden="DESC"
			load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
		}
	});
	$( "#CheckIdcategoria" ).click(function() {
    	if ($( "#CheckIdcategoria" ).is(':checked')){
			crearCookie("mostrarIdcategoriaCategoria", "si");
			$('.Cidcategoria').show();
		}else{
			crearCookie("mostrarIdcategoriaCategoria", "no");
			$('.Cidcategoria').hide();
		}	
	});
	$( "#CheckCodigo" ).click(function() {
    	if ($( "#CheckCodigo" ).is(':checked')){
			crearCookie("mostrarCodigoCategoria", "si");
			$('.Ccodigo').show();
		}else{
			crearCookie("mostrarCodigoCategoria", "no");
			$('.Ccodigo').hide();
		}	
	});
	$( "#CheckNombre" ).click(function() {
    	if ($( "#CheckNombre" ).is(':checked')){
			crearCookie("mostrarNombreCategoria", "si");
			$('.Cnombre').show();
		}else{
			crearCookie("mostrarNombreCategoria", "no");
			$('.Cnombre').hide();
		}	
	});
	$( "#CheckComposicion" ).click(function() {
    	if ($( "#CheckComposicion" ).is(':checked')){
			crearCookie("mostrarComposicionCategoria", "si");
			$('.Ccomposicion').show();
		}else{
			crearCookie("mostrarComposicionCategoria", "no");
			$('.Ccomposicion').hide();
		}
	});
