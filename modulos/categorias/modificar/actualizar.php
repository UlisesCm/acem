  ...
  <body class="sidebar-mini <?php include("../../../componentes/skin.php");?>">
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Categoria<small>Modificar registro</small>
          </h1>
          <ol class="breadcrumb">
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['categorias']['modificar']) or  !isset($_SESSION['permisos']['categorias']['acceso'])){
	...
	/////FIN  DE PERMISOS////////
			...
			<?php include("../../../componentes/avisos.php");?>
          	...
          	<!-- Horizontal Form -->
            <div class="box box-info" style="border-color:#ffda06">
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
                ...
                <div class="box-footer">
				  <input name="idcategoria" type="hidden" id="cidcategoria" value="<?php echo $id;?>"/>
                  <button type="button" class="btn btn-default" id="botonCancelar" onclick="vaciarCampos();">Limpiar</button>
                  <button type="button" class="btn btn-primary pull-right" id="botonGuardar"><i class="fa fa-save"></i>&nbsp;&nbsp;&nbsp;Guardar</button>
                </div><!-- /.box-footer -->
              </form>
              <div id="loading" class="overlay" style="display:none">
  					<i class="fa fa-cog fa-spin" style="color:#ffda06"></i>
			  </div>
...
var sprytextfield1 = new Spry.Widget.ValidationTextField("Vcodigo", "none", {validateOn:["blur"],  maxChars:10,  minChars:1});
				var sprytextfield2 = new Spry.Widget.ValidationTextField("Vnombre", "none", {validateOn:["blur"],  maxChars:150,  minChars:1});
				var sprytextfield1 = new Spry.Widget.ValidationTextField("Vcodigo", "none", {validateOn:["blur"],  maxChars:10,  minChars:1});
				var sprytextfield2 = new Spry.Widget.ValidationTextField("Vnombre", "none", {validateOn:["blur"],  maxChars:150,  minChars:1});
