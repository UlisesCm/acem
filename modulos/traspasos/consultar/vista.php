    ...
    <div class="wrapper s">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Traspasos<small> Consulta</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Consultar traspaso</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['traspasos']['consultar']) or  !isset($_SESSION['permisos']['traspasos']['acceso'])){
