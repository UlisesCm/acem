    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Traspasos<small>Modificar registro</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Modificar traspaso</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['traspasos']['modificar']) or  !isset($_SESSION['permisos']['traspasos']['acceso'])){
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input value="<?php echo $idsucursalorigen; ?>" name="idsucursalorigen" type="text" class="form-control" id="cidsucursalorigen" />
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input value="<?php echo $idsucursaldestino; ?>" name="idsucursaldestino" type="text" class="form-control" id="cidsucursaldestino" />
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input value="<?php echo $fechasalida; ?>" name="fechasalida" type="date" required="required" class="form-control" id="cfechasalida" />
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input value="<?php echo $fechaentrada; ?>" name="fechaentrada" type="date" required="required" class="form-control" id="cfechaentrada" />
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input value="<?php echo $idusuariosalida; ?>" name="idusuariosalida" type="text" class="form-control" id="cidusuariosalida" />
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input value="<?php echo $idusuarioentrada; ?>" name="idusuarioentrada" type="text" class="form-control" id="cidusuarioentrada" />
                ...
                <div class="box-footer">
				  <input name="idtraspaso" type="hidden" id="cidtraspaso" value="<?php echo $id;?>"/>
