...
$consulta="SELECT * FROM concentrados WHERE numerocomprobante='$numerocomprobante' AND tipo='diferencia' ORDER BY clase ASC";
...
<table bordercolor="#CCCCCC" border="1" style="border-collapse:collapse;max-width:195mm;">
	<tr>
    	<td style="width:100mm"><img src="dist/css/imagenes/logofumylim.jpg" width="300" height="70" /></td>
        <td style="width:95mm">
        	<table border="0" style="font-weight:bold; font-size:20px; width:100%;">
            	<tr align="center">
        			<td style="width:95mm">
                    	Reporte de inventario (<?php echo $idmedicion; ?>)
                    </td>
                </tr>
            </table>
        	<table border="0" style="font-size:10px; width:100%">
                  <tr>
                    <td style="width:20mm"><b>Fecha:</b></td>
                    <td style="width:65mm"><?php echo $fecha; ?></td>
                  </tr>
                  <tr>
                    <td style="width:20mm"><b>Técnico:</b></td>
                    <td style="width:65mm"><?php echo strtoupper(html_entity_decode($tecnico)); ?></td>
                  </tr>
                  <tr>
                    <td style="width:20mm"><b>Periodo:</b></td>
                    <td style="width:65mm"><?php echo $fechainicio." - ".$fechafin ?></td>
                  </tr>
			</table>
