            ...
            <div class="box box-info" style="border-color:#25c274">
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-5">
                    	<select id="cconcepto" name="concepto" class="form-control">
                            ...
                            <option value="TRASPASO">TRASPASO ENTRE ALMACENES CONTROLADO</option>
							<option value="DEVOLUCION">DEVOLUCION SOBRE VENTA</option>
				...
				<div class="form-group otro" style="display:none;">
                        <label for="otro_ajax" class="col-sm-2 control-label" id="LabelOtros"></label>
                        <div class="col-sm-4">
                          <select id="otro_ajax" name="otro" class="form-control">
                          </select>
                        </div>
                        
                        <div class="col-sm-1">
                        	<input type="button" value="Procesar" class="form-control btn btn-success botonProcesar" style="display:none;"/>
                    	</div>
                </div>
                
                <div class="form-group comprobante">
                    <label for="cnumerocomprobante" class="col-sm-2 control-label">No. comprobante:</label>
                    <div class="col-sm-2 comprobante">
                ...
                <div class='row' style="padding:20px;">
                    ...
                    <div class='col-sm-1'>
                        <div class='form-group'>
                            <label for="npesototal">Peso total</label>
                            <input value="0" name="npesototal" type="text" class="form-control" id="npesototal"/>
                        </div>
                    </div>
                    ...
                    <table id="tablaSalida" class="table table-hover table-bordered">
                        <thead>
                            <tr style="background:#F3F3F3; color:#666; height:30px; border:1px" align="center">
                                ...
                                <td width="150" style="display:none">Ubicación</td>
