...
function validar(){
	...
	if(validarFormatoFecha($('#cfechamovimiento').val())==false){
		estado=false;
		mensaje="fracaso@Fecha inv&aacute;lida@<p>Ingrese una fecha v&aacute;lida siguiendo el patr&oacute;n dd/mm/aaaa.</p>";
	}
	if(validarFormatoFecha($('#cfechamovimiento').val())==false){
		estado=false;
		mensaje="fracaso@Fecha inv&aacute;lida@<p>Ingrese una fecha v&aacute;lida siguiendo el patr&oacute;n dd/mm/aaaa.</p>";
