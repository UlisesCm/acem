...
<html>
  <head>
	...
	<script src="../../../plugins/jQuery/jQuery-2.1.4.min.js?V=1"></script>
    <script src="../../../librerias/js/jquery-ui.js?V=1"></script>
    <link rel="stylesheet" type="text/css" media="screen" href="../../../dist/css/jquery-ui.css?V=1" />
    <script src="../../../bootstrap/js/bootstrap.min.js?V=1" type="text/javascript"></script>
    <script src="../../../plugins/slimScroll/jquery.slimscroll.min.js?V=1" type="text/javascript"></script>
    <script src="../../../plugins/fastclick/fastclick.min.js?V=1"></script>
    <script src="../../../dist/js/app.min.js?V=1" type="text/javascript"></script>
    <script src="js.js?V=1"></script>
    <script src="../../../librerias/js/cookies.js?V=1"></script>
    <script src="../../../librerias/js/validaciones.js?V=1"></script>
	...
	/////FIN  DE PERMISOS////////
            ...
            <div class="box box-info" style="border-color:#909">
              <div class="box-header with-border">
                ...
                <label class= "label pull-right bg-red" style="margin-left:10px;">Folio: <span id="lserie"><?php echo $serie?></span>-<span id="lfolio"><?php echo $folio?></span></label>
                <label class= "label pull-right bg-yellow">Fecha: <?php echo $fecha; ?></label>
              </div><!-- /.box-header -->
              <!-- form start -->
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
                ...
                <div class="form-group">
                    <label for="cfecha" class="col-sm-2 control-label">Proveedor:</label>
                    <div class="col-sm-3">
                    	<input value="<?php echo $idproveedor; ?>" name="idproveedor" type="hidden" required class="form-control" id="idproveedor"/>
                        <input value="<?php echo $nombreproveedor; ?>" name="proveedor" type="text" required class="form-control" id="cproveedor" disabled/>
                    </div>
                </div>
                ...
                <div class='row' style="padding:20px;">
                    ...
                    <div class='col-sm-2 hide'>
                        <div class='form-group'>
                            <label for="npesoreal">Peso Real</label>
                            <input value="" name="pesoreal" type="text" class="form-control" id="npesoreal"/>
                        </div>
                    </div>
                ...
                <div class="box-footer">
                	<input type="hidden" id="cidrequisicion" name="idrequisicion" value="<?php echo $id?>">
