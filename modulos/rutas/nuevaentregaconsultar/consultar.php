...
$resultado=$Ocotizacionproducto->mostrar($campoOrden, $orden, $inicial, $cantidadamostrar, $busqueda, $papelera, $idcliente,$filtrarfecha,$fechainicio,$fechafin,"ENTREGA EN SUCURSAL","ENTREGADO",0);
...
if ($tipoVista=="tabla"){ // Si se ha elegido el tipo tabla ?>
	<div class="box-body table-responsive no-padding"> <!-- /.box-body -->
    	<table class="table table-hover table-bordered">
        	<tr>
                ...
                <th class="Cfecha">Fecha y Hora Cotización</th>
                <th class="Cfechaentrega">Fecha y Hora Entrega</th>
	...
	while ($filas=mysqli_fetch_array($resultado)) { ?>
      		<tr id="iregistro<?php echo $filas['idcotizacionproducto'] ?>">
                ...
                <?php
				//FECHA ENTREGA
				$fechaNfecha=date_create($filas['fechaentrega']);
				$nuevaFecha= date_format($fechaNfecha, 'd/m/Y');
				?>
                <td class="Cfechaentrega"><?php echo $nuevaFecha." " .$filas['horaentregainicio']; ?></td>
                ...
                ?>
                    ...
                    <?php }else{ ?>
                        <a class="btn btn-danger btn-xs" id="botoncancelar" title="Cancelar entrega" onclick="(cancelarEntrega(<?php echo $filas['idcotizacionproducto'] ?>))"><li class="fa fa-close"></li></a>
                    <?php }?>
                <?php 
                }else{ ?>
                    <a class="btn btn-danger btn-xs disabled"><i class="fa fa-close"></i></a>
