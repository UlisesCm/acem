    ...
    <div class="wrapper s">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Rutas liquidadas <small> Consulta</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Consultar rutas liquidadas</a></li>
          </ol>
        </section>
                    ...
                    <div class='row' style="padding-left:20px; padding-right:20px; padding-bottom:0px; margin-bottom:0px;"><!-- /.Row -->
                          <div class='col-sm-2'>
                            <div class="form-group">
                            	<label for="cfechainicio">Rutas de:</label>
                        ...
                        <div class="col-sm-3">
                             <div class="form-group ">
                                <label for="idruta_ajax">Rutas liquidadas:</label>
