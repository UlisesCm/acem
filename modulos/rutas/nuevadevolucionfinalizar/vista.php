	...
	/////FIN  DE PERMISOS////////
        	...
        	<?php include("../../../componentes/avisos.php");?>
             ...
             <form class="form-horizontal" name="formulario" id="formulario" method="post">
              <input name="idcotizacionproducto" type="hidden" id="idcotizacionproducto" value="<?php if (isset($_POST['idcotizacionproducto'])){echo $_POST['idcotizacionproducto'];}else{echo "";}?>"/>
               <input name="estadoentrega" type="hidden" id="estadoentrega" value="<?php if (isset($_POST['estadoentrega'])){echo $_POST['estadoentrega'];}else{echo "";}?>"/>
            </form>
          	<!-- box -->
            <div class="box box-info" style="border-color:#4da8ac">
                ...
                <div class="box-footer">
                 <input value="0" name="TotalCantidadDevuelta" type="" class="form-control" id="TotalCantidadDevuelta" />
                 <input value="" name="listaSalida" type="" class="form-control" id="listaSalida" />
                <div class="row">
                        <div class='col-sm-12 pull-right'>
                            <div class="form-group">
                            		<button type="button" style="d<?php if (isset($_POST['hiddenbotonaceptar'])){echo $_POST['hiddenbotonaceptar'];}else{echo "";}?>" class="btn btn-success pull-right" id="botonAceptar"><i class="fa fa-save"></i>&nbsp;&nbsp;&nbsp;Autorizar entrada</button>
                            </div>
                		</div>
                         </div>
                </div>
