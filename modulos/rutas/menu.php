    ...
    <nav style="padding-left:0; margin-left:0px;">
		...
		<ul>
			...
			<li>
				...
				<div id="labelMenu">Nuevo ruta</div>
				</a>
			</li>
			<?php }?>
			...
			<li>
				...
				<div id="labelMenu">Consultar rutas</div>
				</a>
			</li>
			<?php }?>
			<?php
			/////PERMISOS////////////////
			if (isset($_SESSION['permisos']['rutas']['papelera'])){
			?>
			<li>
				...
				<div id="labelMenu">Papelera de rutas</div>
				</a>
			</li>
			<?php }?>
