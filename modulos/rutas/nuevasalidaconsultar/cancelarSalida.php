...
if($validacion){
	...
	$resultado=$Ocotizacionproducto->cancelarSalida($idruta);
	if($resultado=="exito"){
	...
	if($resultado=="estadoentrega"){
		$mensaje="fracaso@No se permite cancelar@El chofer ya ha marcado como entregado o no entregado al menos una nota de venta de esta ruta";
	}
}else{
