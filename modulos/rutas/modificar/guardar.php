...
if (isset($_POST['idruta'])){
	...
	//$idruta=mysql_real_escape_string($idruta);
}else{
	$validacion=false;
...
if($validacion){
	$resultado=$Oruta->actualizar($serie,$folio,$nombre,$fecha,$idempleado,$observacionesruta,$observacionessalida,$autorizada,$estatus, $idruta);
	if($resultado=="exito"){
