...
class Detallecotizacionproducto{
 //constructor	
	...
	function mostrarTotalProductosACagar($campoOrden, $orden, $inicial, $cantidadamostrar, $condicion, $papelera, $idruta){
		/////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['detallecotizacionesproductos']['consultar'])){
			return "denegado";
			exit;
		...
		$detallecotizacionesproductos = "detallecotizacionesproductos" . $_SESSION["idsucursal"];
		$cotizacionesproductos = "cotizacionesproductos" . $_SESSION["idsucursal"];
		$where="WHERE $detallecotizacionesproductos.iddetallecotizacion<>0 AND $cotizacionesproductos.idruta = $idruta";
	...
	function mostrarTotalProductosADevolver($campoOrden, $orden, $inicial, $cantidadamostrar, $condicion, $papelera, $idcotizacionproductodevolucion){
		/////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['detallecotizacionesproductos']['consultar'])){
			return "denegado";
			exit;
		...
		$detallecotizacionesproductos = "detallecotizacionesproductos" . $_SESSION["idsucursal"];
		$cotizacionesproductos = "cotizacionesproductos" . $_SESSION["idsucursal"];
		$where="WHERE $detallecotizacionesproductos.iddetallecotizacion<>0 AND $cotizacionesproductos.idcotizacionproducto = $idcotizacionproductodevolucion";
		...
		$consulta = "SELECT 
					...
					$detallecotizacionesproductos.costo,
					$detallecotizacionesproductos.precio,
					SUM($detallecotizacionesproductos.subtotal) AS subtotal,
					SUM($detallecotizacionesproductos.impuestos) AS impuestos,
					SUM($detallecotizacionesproductos.total) AS total,
					SUM($detallecotizacionesproductos.utilidad) AS utilidad,
					$detallecotizacionesproductos.idcotizacionproducto,
					SUM($detallecotizacionesproductos.impuestos) AS impuestos,
					SUM($detallecotizacionesproductos.pesounitario) AS pesounitario,
					$detallecotizacionesproductos.cantidadentregada,
					$cotizacionesproductos.idruta,
					Productos.nombre AS nombreproducto 
					FROM $detallecotizacionesproductos 
