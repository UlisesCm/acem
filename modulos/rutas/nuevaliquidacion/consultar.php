      		...
      		<tr id="iregistro<?php echo $filas['idcotizacionproducto'] ?>">
        		...
        		<td style="display:none">
                    ...
                    ?>
                        ...
                        <?php }else{ ?>
                            <a class="btn btn-danger btn-xs" title="No liquidado" onclick="(actualizarEstadoLiquidacion(<?php echo $filas['idcotizacionproducto']?>,'NO LIQUIDADO'))"><li class="fa fa-close"> CANCELAR LIQUIDACION</li></a>
                        <?php }?>
                    <?php 
                    }else{ ?>
                        <a class="btn btn-danger btn-xs disabled"><i class="fa fa-close"></i></a>
                ...
                <td>
                    ...
                    if (isset($_SESSION['permisos']['cotizacionesproductos']['eliminar'])){
                    ?>
                        <?php if($filas['idcotizacionproducto']==0  || $filas['estadoliquidacion']=="LIQUIDADO"){ ?>
                            <a class="btn btn-success btn-xs disabled"><i class="fa fa-check"> LIQUIDAR</i></a>
                        <?php }else{ ?>
                            <a class="btn btn-success btn-xs" title="Liquidar" onclick="(actualizarEstadoLiquidacion('<?php echo $filas['idcotizacionproducto'] ?>','LIQUIDADO','<?php echo $filas['estadopago'] ?>','<?php echo $filas['estadoentrega'] ?>','<?php echo $filas['estadoentregaanterior'] ?>','<?php echo $filas['envio'] ?>','<?php echo $filas['idcliente'] ?>','<?php echo $filas['idruta'] ?>'))"><li class="fa fa-check">LIQUIDAR</li></a>
                        <?php }?>
                    <?php 
                    }else{ ?>
