...
function actualizarEstadoEntrega(idcotizacionproducto,estadoentrega,estadoentregabd){
	//var autorizacion = $(".Cautorizada"+no).html();
	$("#loading").show();
	$.ajax({
		url: 'actualizarEstadoEntrega.php',
		type: "POST",
		data: "submit=&idcotizacionproducto="+idcotizacionproducto+"&estadoentrega="+estadoentrega+"&estadoentregabd="+estadoentregabd, //Pasamos los datos en forma de array
		success: function(mensaje){
			$("#loading").hide();
...
function actualizarObservaciones(idcotizacionproducto,no){
	var observaciones = $("#observacionesentrega"+no).val()
	$("#loading").show();
	$.ajax({
