...
function actualizarEstadoLiquidacion(idcotizacionproducto,estadoliquidacion,estadopago,estadoentrega,envio,idcliente){
	$("#loading").show();
	$.ajax({
...
function cancelarDevolucion(idcotizacionproducto,estadoentregaanterior){
	$("#loading").show();
	$.ajax({
		url: 'cancelarDevolucion.php',
		type: "POST",
		data: "submit=&idcotizacionproducto="+idcotizacionproducto+"&estadoentregaanterior="+estadoentregaanterior, //Pasamos los datos en forma de array
		success: function(mensaje){
			$("#loading").hide();
			mostrarMensaje(mensaje);
			load_tablas(campoOrden,orden,cantidadamostrar,paginacion,busqueda,tipoVista);
...
function llenarSelectRuta(condicion){
		...
		$.ajax({
			url: '../componentes/llenarSelectRutasConDevoluciones.php',
			type: "POST",
