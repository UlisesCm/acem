...
$resultado="";
if($idruta!=""){
	$resultado=$Ocotizacionproducto->mostrarDevolucionesRuta($campoOrden, $orden, $inicial, $cantidadamostrar, $busqueda, $papelera, $idruta);
        		...
        		<td>
                    ...
                    ?>
                        <?php if($filas['idcotizacionproducto']==0 || $filas['estadoliquidacion']=="LIQUIDADO"){ ?>
                            <a class="btn btn-danger btn-xs disabled"><i class="fa fa-close"> CANCELAR DEVOLUCIÓN</i></a>
                        <?php }else{ ?>
                            <a class="btn btn-danger btn-xs" title="Cancelar devolución" onclick="(cancelarDevolucion(<?php echo $filas['idcotizacionproducto'] ?>,'<?php echo $filas['estadoentregaanterior'] ?>'))"><li class="fa fa-close"> CANCELAR DEVOLUCIÓN</li></a>
                        <?php }?>
                    <?php 
                    }else{ ?>
