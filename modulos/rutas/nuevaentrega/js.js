...
function actualizarVenta(idcotizacionproducto,no){
		var observacionesentrega =  $("#observacionesentrega"+no+"").val();
		$("#botonentregar"+no+"").hide();
		$("#loading").show();
		$.ajax({
			url: 'guardarentrega.php',
			type: "POST",
			data: "submit=&observacionesentrega="+observacionesentrega+"&idcotizacionproducto="+idcotizacionproducto, //Pasamos los datos en forma de array
			success: function(mensaje){
				$("#botonentregar"+no+"").show();
				$("#loading").hide();
