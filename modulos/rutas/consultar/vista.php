                ...
                <div class="box-body">
                    <div class='row' style="padding-left:20px; padding-right:20px; padding-bottom:0px; margin-bottom:0px;"><!-- /.Row -->
                        	...
                        	<div class="form-group hide">
                                <label for="rutaConsulta" >rutaConsulta:</label>
                                <input value="" id="rutaConsulta" name="rutaConsulta" type="hidden" class="form-control"/>
                        	</div>
            ...
            <div class="col-md-12">
                    ...
                    <div class="box box-info" style="border-color:#A46BD1">
                        ...
                        <div style="min-height:100px;"> <!-- mapa -->
                            ...
                            <div id="mapaRuta" style=" width:100%; height:300px;"></div>
