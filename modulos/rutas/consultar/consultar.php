...
if ($tipoVista=="tabla"){ // Si se ha elegido el tipo tabla ?>
	<div class="box-body table-responsive no-padding"> <!-- /.box-body -->
    	<table class="table table-hover table-bordered">
        	<tr>
				...
				<th class="Cidruta" style="display:none">ID</th>
	...
	while ($filas=mysqli_fetch_array($resultado)) { ?>
      		<tr id="iregistro<?php echo $filas['idruta'] ?>">
				...
				<td class="Cidruta" style="display:none"><?php echo $filas['idruta']; ?></td>
                ...
                ?>
                    <?php if($filas['idruta']==0){ ?>
                        <a class="btn btn-default btn-xs disabled"><i class="fa fa-map"></i></a>
                    <?php }else{ ?>
                        <a class="btn btn-default btn-xs" id="botonVerRutaenMapa" title="Ver ruta en mapa" onclick="(verRutaenMapa(<?php echo $filas['idruta'] ?>,<?php echo $con?>))"><li class="fa fa-map"></li></a>
                    <?php }?>
                <?php 
                }else{ ?>
                    <a class="btn btn-default btn-xs disabled"><i class="fa fa-map"></i></a>
                ...
                <td>
					...
					?>
						<form target="_blank" action="../../../modulos/cotizacionesproductos/consultar/vista.php?n1=logisticaysalidas&n2=enviosadomicilio&n3=rutas&n4=consultarrutas" method="post">
                ...
                ?>
                    ...
                    <?php }else{ ?>
                        <a class="btn btn-danger btn-xs" id="botoncancelar" title="Cancelar ruta" onclick="(cancelarRuta(<?php echo $filas['idruta'] ?>,<?php echo $con?>))"><li class="fa fa-close"></li></a>
                    <?php }?>
                <?php 
                }else{ ?>
                    <a class="btn btn-danger btn-xs disabled"><i class="fa fa-close"></i></a>
