	...
	<div class="box-body table-responsive no-padding"> <!-- /.box-body -->
    	<table class="table table-hover table-bordered">
        	<tr>
				...
				<th class="Cpreciopublico">Precio público</th>
				<th class="Ccomisiongeneral">Comisión general</th>
				<th class="Ccomisionreferenciado">Comisión referenciado</th>
				<th class="Ccomisionmaster">Comisión master</th>
