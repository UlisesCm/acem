...
if($validacion){
	$resultado=$Oprecios->actualizar($idlistaprecios,$idreferencia,$descripcion,$preciopublico,$comisiongeneral,$comisionreferenciado,$comisionmaster,$precioproveedor, $idprecio);
	if($resultado=="exito"){
