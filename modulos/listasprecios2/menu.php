		...
		<ul>
			...
			<li>
				<div class="tituloMenu">
					<div id="labelMenu">listasprecios</div>
				</div>
			</li>
			<?php
			/////PERMISOS////////////////
			...
			<li>
				...
				<div id="labelMenu">Nuevo listaprecios</div>
				</a>
			</li>
			<?php }?>
			...
			<li>
				...
				<div id="labelMenu">Consultar listasprecios</div>
				</a>
			</li>
			<?php }?>
			<?php
			...
			<li>
				...
				<div id="labelMenu">Papelera de listasprecios</div>
				</a>
			</li>
			<?php }?>
