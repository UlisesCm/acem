    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Retiro<small>Modificar registro</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Modificar retiro</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['retiros']['modificar']) or  !isset($_SESSION['permisos']['retiros']['acceso'])){
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input value="<?php echo $cheque; ?>" name="cheque" type="text" class="form-control" id="ccheque" />
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input value="<?php echo $idcuenta; ?>" name="idcuenta" type="text" class="form-control" id="cidcuenta" />
                ...
                <div class="box-footer">
				  <input name="idretiro" type="hidden" id="cidretiro" value="<?php echo $id;?>"/>
