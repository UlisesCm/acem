          ...
          <ul class="dropdown-menu dropdown-menu-form" style="min-width:250px;;">
            ...
            <li><a>
            	<select id="campoOrden" class="form-control input-sm">
									...
									<option value="idcuenta">Cuenta</option>
                </select>
                </a>
    		</li>
            ...
            <li><span class="titulo-herramientas">Mostrar / Ocultar campos</span></li>
				...
				<li><a><input id="CheckCheque" name="kcheque" value="si" checked="checked" type="checkbox"/><label for="CheckCheque">&nbsp;&nbsp;Cheque</label></a></li>
			
				<li><a><input id="CheckIdcuenta" name="kidcuenta" value="si" checked="checked" type="checkbox"/><label for="CheckIdcuenta">&nbsp;&nbsp;Cuenta</label></a></li>
