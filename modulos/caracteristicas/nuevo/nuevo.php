    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Caracteristicas<small>Nuevo registro</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Nuevo caracteristica</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['caracteristicas']['guardar']) or  !isset($_SESSION['permisos']['caracteristicas']['acceso'])){
            ...
            <div class="box box-info" style="border-color:#e41d36">
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-3">
                    	<span id="Vvalor">
                        <input value="" name="valor" type="text" class="form-control" id="cvalor" />
