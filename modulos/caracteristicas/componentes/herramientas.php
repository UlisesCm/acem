          ...
          <ul class="dropdown-menu dropdown-menu-form" style="min-width:250px;;">
            ...
            <li><a>
            	<select id="campoOrden" class="form-control input-sm">
									<option value="idcaracteristica">ID</option>
            ...
            <li><span class="titulo-herramientas">Mostrar / Ocultar campos</span></li>
				...
				<li><a><input id="CheckIdcaracteristica" name="kidcaracteristica" value="si" checked="checked" type="checkbox"/><label for="CheckIdcaracteristica">&nbsp;&nbsp;ID</label></a></li>
			
				<li><a><input id="CheckCaracteristica" name="kcaracteristica" value="si" checked="checked" type="checkbox"/><label for="CheckCaracteristica">&nbsp;&nbsp;Caracteristica</label></a></li>
			
				<li><a><input id="CheckValor" name="kvalor" value="si" checked="checked" type="checkbox"/><label for="CheckValor">&nbsp;&nbsp;Valor</label></a></li>
