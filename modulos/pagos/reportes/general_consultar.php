...
$Opago=new Pago;
$resultado=$Opago->mostrarA($campoOrden, $orden, $inicial, $cantidadamostrar, $busqueda, $papelera, $idalmacen, $idcliente, $ticket, $tipo, $filtrarfecha, $fechainicio, $fechafin, $formapago, $diacobro, $facturada, $domicilio, "");
