...
<script src="rep_js.js?v1"></script>
...
<body class="sidebar-mini <?php include("../../../componentes/skin.php");?>">
    ...
    <div class="wrapper s">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Cobranza para REP<small> Consulta</small>
          </h1>
          <ol class="breadcrumb">
	...
	/////FIN  DE PERMISOS////////
			...
			<?php $herramientas="consultar"; include("../componentes/herramientas2.php"); ?>
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
                <div class="box-body">
                	<div class='row' style="padding-left:20px; padding-right:20px; padding-bottom:0px; margin-bottom:0px;">
                        ...
                        <div class='col-sm-1'>
                            <div class="form-group">
                           		<label for="cticket">Ticket:</label>
                        ...
                        <div class='col-sm-3'>	
                        	<div class="form-group">
                                <label for="crfccliente">RFC:</label>
                    ...
                    <div class='row' style="padding-left:20px; padding-right:20px; padding-bottom:0px; margin-bottom:0px;"><!-- /.Row -->
                        ...
                        <div class='col-sm-2 hide'>
                            <div class="form-group">
                            		...
                            		<select id="cfacturada" name="facturada" class="form-control">
                                    	<option value="">TODAS</option>
                                        <option value="no">SIN FACTURAR</option>
                                        <option value="si" selected>FACTURADAS</option>
                            		</select>
                            </div>
                		</div>
                        ...
                        <div class='col-sm-2'>
                            <div class="form-group">
                            		...
                            		<select id="cdomicilio" name="domicilio" class="form-control">
                        ...
                        <div class='col-sm-2'>
                            <div class="form-group">
                            		<label for="cestadopago">Estado del pago: </label>
                            		<select id="cestadopago" name="estadopago" class="form-control">
                                        <option value="CON REP">PAGOS CON REP</option>
                                        <option value="SIN REP" selected>PAGOS SIN REP</option>
                    	...
                    	<div class='col-sm-2'>
                            <div class="form-group">
                            	<label for="cfechainicio">pagos de:</label>
