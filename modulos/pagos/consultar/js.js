...
function comprobarReglas(){
	...
	if(recuperarCookie("campoOrdenPago")!=null){
		campoOrden=recuperarCookie("campoOrdenPago");
	...
	if(recuperarCookie("cantidadamostrarPago")!=null){
		cantidadamostrar=recuperarCookie("cantidadamostrarPago");
	...
	if(recuperarCookie("ordenPago")=="asc"){
		orden="ASC"
		$('#asc').attr('checked', true);
		$('#desc').attr('checked', false);
	}else if(recuperarCookie("ordenPago")=="desc"){
		orden="DESC"
	...
	//Mostrar u Ocultar Idpago
	if(recuperarCookie("mostrarIdpagoPago")=="si"){
		$('.Cidpago').show();
		$('#CheckIdpago').attr('checked', true);
	}else if(recuperarCookie("mostrarIdpagoPago")=="no"){
		$('.Cidpago').hide();
		$('#CheckIdpago').attr('checked', false);
	}
	//Mostrar u Ocultar Idventa
	if(recuperarCookie("mostrarIdventaPago")=="si"){
		$('.Cidventa').show();
		$('#CheckIdventa').attr('checked', true);
	}else if(recuperarCookie("mostrarIdventaPago")=="no"){
		$('.Cidventa').hide();
		$('#CheckIdventa').attr('checked', false);
	}
	//Mostrar u Ocultar Idcliente
	if(recuperarCookie("mostrarIdclientePago")=="si"){
		$('.Cidcliente').show();
		$('#CheckIdcliente').attr('checked', true);
	}else if(recuperarCookie("mostrarIdclientePago")=="no"){
		$('.Cidcliente').hide();
		$('#CheckIdcliente').attr('checked', false);
	}
	//Mostrar u Ocultar Composicion
	if(recuperarCookie("mostrarComposicionPago")=="si"){
		$('.Ccomposicion').show();
		$('#CheckComposicion').attr('checked', true);
	}
	if(recuperarCookie("mostrarComposicionPago")=="no"){
		$('.Ccomposicion').hide();
		$('#CheckComposicion').attr('checked', false);
	}
	
	//Elegir el tipo de vista
	if(recuperarCookie("tipoVistaPago")=="tabla"){
		$('.tipoLista').show();
		$('.tipoTabla').hide();
		tipoVista="tabla";
	}else{
	...
	$( ".tipoTabla" ).click(function() {
    	crearCookie("tipoVistaPago", "tabla");
		tipoVista="tabla";
		$(".tipoLista").show();
		$(".tipoTabla").hide();
	...
	$( ".tipoLista" ).click(function() {
    	crearCookie("tipoVistaPago", "lista");
		tipoVista="lista";
		$(".tipoLista").hide();
		$(".tipoTabla").show();
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
...
$(document).ready(function() {
	...
	$("#campoOrden").change(function(){
		...
		crearCookie("campoOrdenPago", campoOrden);
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
	});
	$("#cantidadamostrar").change(function(){
		cantidadamostrar = this.value;
		crearCookie("cantidadamostrarPago", cantidadamostrar);
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
	});
	$( "#asc" ).click(function() {
    	if ($( "#asc" ).is(':checked')){
			crearCookie("ordenPago", "asc");
			orden="ASC"
			load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
		}
	});
	$( "#desc" ).click(function() {
    	if ($( "#desc" ).is(':checked')){
			crearCookie("ordenPago", "desc");
			orden="DESC"
			load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
		}
	});
	$( "#CheckIdpago" ).click(function() {
    	if ($( "#CheckIdpago" ).is(':checked')){
			crearCookie("mostrarIdpagoPago", "si");
			$('.Cidpago').show();
		}else{
			crearCookie("mostrarIdpagoPago", "no");
			$('.Cidpago').hide();
		}	
	});
	$( "#CheckIdventa" ).click(function() {
    	if ($( "#CheckIdventa" ).is(':checked')){
			crearCookie("mostrarIdventaPago", "si");
			$('.Cidventa').show();
		}else{
			crearCookie("mostrarIdventaPago", "no");
			$('.Cidventa').hide();
		}	
	});
	$( "#CheckIdcliente" ).click(function() {
    	if ($( "#CheckIdcliente" ).is(':checked')){
			crearCookie("mostrarIdclientePago", "si");
			$('.Cidcliente').show();
		}else{
			crearCookie("mostrarIdclientePago", "no");
			$('.Cidcliente').hide();
		}	
	});
	$( "#CheckComposicion" ).click(function() {
    	if ($( "#CheckComposicion" ).is(':checked')){
			crearCookie("mostrarComposicionPago", "si");
			$('.Ccomposicion').show();
		}else{
			crearCookie("mostrarComposicionPago", "no");
			$('.Ccomposicion').hide();
		}
	});
