...
<body class="sidebar-mini <?php include("../../../componentes/skin.php");?>">
    ...
    <div class="wrapper s">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Cortesdecaja<small> Consulta</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Consultar cortedecaja</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['cortesdecaja']['consultar']) or  !isset($_SESSION['permisos']['cortesdecaja']['acceso'])){
	...
	/////FIN  DE PERMISOS////////
        	...
        	<?php include("../../../componentes/avisos.php");?>
          	<!-- box -->
            <div class="box box-info" style="border-color:#ede263">
                ...
                <div id="loading" class="overlay">
  					<i class="fa fa-cog fa-spin" style="color:#ede263"></i>
			  	</div>
