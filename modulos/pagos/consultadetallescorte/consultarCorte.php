...
//recibimos el idcortedecaja desde el boton de consultar
if (isset($_REQUEST['idcortedecaja']) && $_REQUEST['idcortedecaja'] !="") {
	if($_REQUEST['idcortedecaja']!="undefined"){
		$idcortedecaja = htmlentities($_REQUEST['idcortedecaja']);
	}else{
		$idcortedecaja="";
	}
}else{
...
?>
	...
	while ($filas=mysqli_fetch_array($resultado)) { ?>
      		<tr id="iregistro<?php echo $filas['idpago'] ?>">
                ...
                <td class="Cmonto" id="<?php echo "totalefectivo".$con ?>"><?php echo $filas['monto']; ?></td>
 ...
 <div class="box box-info" style="border-color:#b4d571">
	...
	while ($filas=mysqli_fetch_array($resultado)) { ?>
      		<tr id="iregistro<?php echo $filas['idpago'] ?>">
				...
				<td class="Cmonto" id="<?php echo "totaltarjetadedebito".$con ?>"><?php echo $filas['monto']; ?></td>
				<td class="Cdescripcion"><?php echo $filas['descripcion']; ?></td>
 ...
 <div class="box box-info" style="border-color:#b4d571">
	...
	while ($filas=mysqli_fetch_array($resultado)) { ?>
      		<tr id="iregistro<?php echo $filas['idpago'] ?>">
				...
				<td class="Cfechapago"><?php echo $nuevaFecha; ?></td>
				<td class="Cformapago"><?php echo $filas['formapago']; ?></td>
				<td class="Cmonto" id="<?php echo "totaltarjetadecredito".$con ?>"><?php echo $filas['monto']; ?></td>
				<td class="Cdescripcion"><?php echo $filas['descripcion']; ?></td>
 ...
 <div class="box box-info" style="border-color:#b4d571">
	...
	while ($filas=mysqli_fetch_array($resultado)) { ?>
      		<tr id="iregistro<?php echo $filas['idpago'] ?>">
				...
				<td class="Cfechapago"><?php echo $nuevaFecha; ?></td>
				<td class="Cformapago"><?php echo $filas['formapago']; ?></td>
				<td class="Cmonto" id="<?php echo "totalcheques".$con ?>"><?php echo $filas['monto']; ?></td>
				<td class="Cdescripcion"><?php echo $filas['descripcion']; ?></td>
 ...
 <div class="box box-info" style="border-color:#b4d571">
	...
	while ($filas=mysqli_fetch_array($resultado)) { ?>
      		<tr id="iregistro<?php echo $filas['idpago'] ?>">
				...
				<td class="Cfechapago"><?php echo $nuevaFecha; ?></td>
				<td class="Cformapago"><?php echo $filas['formapago']; ?></td>
				<td class="Cmonto" id="<?php echo "totaltransferencias".$con ?>"><?php echo $filas['monto']; ?></td>
				<td class="Cdescripcion"><?php echo $filas['descripcion']; ?></td>
 ...
 <div class="box box-info" style="border-color:#b4d571">
	...
	while ($filas=mysqli_fetch_array($resultado)) { ?>
      		<tr id="iregistro<?php echo $filas['idpago'] ?>">
				...
				<td class="Cfechapago"><?php echo $nuevaFecha; ?></td>
				<td class="Cformapago"><?php echo $filas['formapago']; ?></td>
				<td class="Cmonto" id="<?php echo "totaldepositos".$con ?>"><?php echo $filas['monto']; ?></td>
				<td class="Cdescripcion"><?php echo $filas['descripcion']; ?></td>
 ...
 <div class="box box-info" style="border-color:#b4d571">
	...
	while ($filas=mysqli_fetch_array($resultado)) { ?>
      		<tr id="iregistro<?php echo $filas['idpago'] ?>">
				...
				<td class="Cfechapago"><?php echo $nuevaFecha; ?></td>
				<td class="Cformapago"><?php echo $filas['formapago']; ?></td>
				<td class="Cmonto" id="<?php echo "totalnotasdecredito".$con ?>"><?php echo $filas['monto']; ?></td>
				<td class="Cdescripcion"><?php echo $filas['descripcion']; ?></td>
