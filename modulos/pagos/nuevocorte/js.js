...
function vaciarCampos(){
	$("#ltotal").html(0);//se reiniciar y con las siguientes consultas ya va acumulando valor
...
function calcularConteo(idcampo,valor) {
	...
	let calculoDiferencia = parseFloat($("#ctotalefectivo").val())- parseFloat($("#sumaEfectivo").val())
	// $("#ldiferencia").html(parseFloat($("#ctotalefectivo").val())- parseFloat($("#sumaEfectivo").val()));
	$("#ldiferencia").html(financial(calculoDiferencia));
...
function recorrerTablaEfectivo(tabla,lista){
	...
	$("#ctotalefectivo").val(financial(total));
	calcularTotales();
	$("#"+lista).val(cadena);
}
...
function recorrerTablaCheques(tabla,lista){
	...
	$("#ctotalcheque").val(financial(total));
...
function recorrerTablaTarjetadedebito(tabla,lista){
	...
	$("#ctotaltarjetadedebito").val(financial(total));
...
function recorrerTablaTarjetadecredito(tabla,lista){
	...
	$("#ctotaltarjetacredito").val(financial(total));
...
function recorrerTablaTransferencias(tabla,lista){
	...
	$("#ctotaltransferencia").val(financial(total));
	calcularTotales();
...
function recorrerTablaDepositos(tabla,lista){
	...
	$("#ctotaldeposito").val(financial(total));
...
function recorrerTablaNotasdecredito(tabla,lista){
	...
	$("#ctotalnotasdecredito").val(financial(total));
...
function calcularTotales(){
	...
	let calculoTotales = parseFloat($("#ctotalefectivo").val()) + parseFloat($("#ctotaltarjetadedebito").val()) + parseFloat($("#ctotaltarjetacredito").val()) + parseFloat($("#ctotalcheque").val()) + parseFloat($("#ctotaltransferencia").val()) + parseFloat($("#ctotaldeposito").val()) + parseFloat($("#ctotalnotadecredito").val())
	$("#ltotaltotal").html(financial(calculoTotales));
...
function financial(saldo) {
	return Number.parseFloat(saldo).toFixed(2);
}
function consultarSaldoSucursal(formadepago,etiqueta){
		...
		$.ajax({
			...
			success: function(mensaje){
				...
				$("#"+etiqueta).html(financial(mensaje));

				// $("#"+etiqueta).html(mensaje);
				//$("#ltotal").html(parseFloat($("#ltotal").html()) + parseFloat($("#"+etiqueta).html()));
				$("#ltotal").html(financial(parseFloat($("#ltotal").html()) + parseFloat($("#"+etiqueta).html())));
			}
		});
		return false;
}
...
function load_tablas (){
	...
	xmlhttp.open("POST","consultarCorte.php", true);
	xmlhttp.send();
}
