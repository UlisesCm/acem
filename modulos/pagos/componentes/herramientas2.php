...
if ($herramientas=="consultar"){
	?>
    <li class="btn-default border-right" title="Crear REP"><a href="#" class="botonFacturar"><i class="fa fa-file-code-o"></i><span class="visible-xs-inline">&nbsp;&nbsp;Crear REP</span></a></li>
		...
		<li class="dropdown btn-defaul border-right" style="background:#F4F4F4;" title="Visualización y ordenamiento">
          ...
          <ul class="dropdown-menu dropdown-menu-form" style="min-width:250px;;">
            ...
            <li><span class="titulo-herramientas">Mostrar / Ocultar campos</span></li>
				...
				<li><a><input id="CheckIdpago" name="kidpago" value="si" checked="checked" type="checkbox"/><label for="CheckIdpago">&nbsp;&nbsp;ID</label></a></li>
			
				<li><a><input id="CheckIdventa" name="kidventa" value="si" checked="checked" type="checkbox"/><label for="CheckIdventa">&nbsp;&nbsp;Venta</label></a></li>
