          ...
          <ul class="dropdown-menu dropdown-menu-form" style="min-width:250px;;">
            ...
            <li><a>
            	<select id="campoOrden" class="form-control input-sm">
									...
									<option value="prefijocodigo">Prefijocodigo</option>
                </select>
                </a>
    		</li>
            ...
            <li><span class="titulo-herramientas">Mostrar / Ocultar campos</span></li>
				...
				<li><a><input id="CheckPrefijocodigo" name="kprefijocodigo" value="si" checked="checked" type="checkbox"/><label for="CheckPrefijocodigo">&nbsp;&nbsp;Prefijocodigo</label></a></li>
