    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Marca<small>Nuevo registro</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Nuevo marca</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['marcas']['guardar']) or  !isset($_SESSION['permisos']['marcas']['acceso'])){
	...
	/////FIN  DE PERMISOS////////
            ...
            <div class="box box-info" style="border-color:#e44545">
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
				...
				<div class="form-group ">
                    <label for="cprefijocodigo" class="col-sm-2 control-label">Prefijo para código:</label>
                    <div class="col-sm-2">
