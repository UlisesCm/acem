...
function comprobarReglas(){
	...
	if(recuperarCookie("mostrarPrefijocodigoMarca")=="si"){
		$('.Cprefijocodigo').show();
		$('#CheckPrefijocodigo').attr('checked', true);
	}else if(recuperarCookie("mostrarPrefijocodigoMarca")=="no"){
		$('.Cprefijocodigo').hide();
...
$(document).ready(function() {
	...
	$( "#CheckPrefijocodigo" ).click(function() {
    	if ($( "#CheckPrefijocodigo" ).is(':checked')){
			crearCookie("mostrarPrefijocodigoMarca", "si");
			$('.Cprefijocodigo').show();
		}else{
			crearCookie("mostrarPrefijocodigoMarca", "no");
			$('.Cprefijocodigo').hide();
		}	
	});
