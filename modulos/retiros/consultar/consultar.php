...
if ($tipoVista=="tabla"){ // Si se ha elegido el tipo tabla ?>
 <form class="form-horizontal" name="formulario" id="formulario" method="post">
     <!-- ESTOS OBJETOS FUERON CREADOS APRA RECIBIR LOS VALORES DE LOS OBJETOS QUE ESTÁN EN EL FORMULARIO DE LA VISTA -->
    <input value="<?php echo date('Y-m-d'); ?>" name="fechaconsulta" type="date" style="display:none" required class="form-control" id="cfechaconsulta" />
	<input value="" name="idcuentaconsulta" type="hidden" class="form-control" id="cidcuenta_ajaxconsulta" />
	<input value="" name="chequeconsulta" type="hidden" class="form-control" id="cchequeconsulta" />
    <input value="" name="descripcion" type="hidden" class="form-control" id="cdescripcionconsulta" />
            ...
            <div class="row"><!-- /.inicio row -->
                <div class="col-lg-12 ">
                    <div class="form-group limpuestos">
                        <div class="col-sm-8">
                            <h3 style="line-height:0px;">Total a retirar:</h3>
                        </div>
                        <div class="col-sm-4">
                            <h3 style="line-height:0px;" id="ltotalaretirar">0.00</h3>
                            <input value="0.00" name="totalRetiro" readonly type="hidden" class="form-control" style="text-align:right; font-weight: bold;" id="ctotalRetiro" />
                        </div>
                    </div>
                    </div>
            </div><!-- /.fin row -->
                ...
                <div class="row filaEspecial">
                    <div class="col-sm-12">
                        <div class="form-group ">
                            ...
                            <button type="button" class="btn btn-success pull-right" id="botonAceptar"  onclick="RegistrarRetiros();"><i class="fa fa-save"></i>&nbsp;&nbsp;&nbsp;Aceptar</button>
                         </div>
                    </div>
                </div><!-- /filaespecial-->
            </div>
