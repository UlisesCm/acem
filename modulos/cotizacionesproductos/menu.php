		...
		<ul>
			...
			<li>
				<div class="tituloMenu">
					<div id="labelMenu">cotizacionesproductos</div>
				</div>
			</li>
			<?php
			/////PERMISOS////////////////
			...
			<li>
				...
				<div id="labelMenu">Nuevo cotizacionproducto</div>
				</a>
			</li>
			<?php }?>
			...
			<li>
				...
				<div id="labelMenu">Consultar cotizacionesproductos</div>
				</a>
			</li>
			<?php }?>
			<?php
			...
			<li>
				...
				<div id="labelMenu">Papelera de cotizacionesproductos</div>
				</a>
			</li>
			<?php }?>
