			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
                <div class="box-body">
                    ...
                    <div class='row' style="padding-left:20px; padding-right:20px; padding-bottom:0px; margin-bottom:0px;"><!-- /.Row -->
                        ...
                        <div class='col-sm-2'>
                            <div class="form-group">
                            		<label for="cestadofacturacion">Estado: </label>
                            		<select id="cestadofacturacion" name="estadofacturacion" class="form-control">
                                        <option value="FACTURADA">FACTURADA</option>
                                        <option value="NO FACTURADO" selected>NO FACTURADA</option>
