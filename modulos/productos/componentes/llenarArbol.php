<?php 
	...
	function crearArbol($idfamilia, $descripcionHeredada, $codigoHeredado, $idfamiliaseleccionada){
		global $arrayFamilia;
		$Ofamilia = new Familia;
		...
		while ($filas2=mysqli_fetch_array($resultado2)) { 
			...
			echo "<ul>";
				echo "<li nombre='$nombre' descripcion='$descripcion' campos='$camposrequeridos' codigo='$codigo' idfamilia='$idfamilia' $seleccionado>";
				echo $nombre;
				crearArbol($idfamilia,$descripcion, $codigo, $idfamiliaseleccionada);
				echo "</li>";
			echo "</ul>";
			}
