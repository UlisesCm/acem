...
$(document).ready(function() {
	...
	llenarChecksProveedores(idproductoSeleccionado,"");
	mostrarCampos(Gcampos);
...
function llenarSelectMarca(seleccionado,condicion){
		$("#idmarca_ajax").html("<option value='1'>cargando...</option>");
		$.ajax({
			url: '../componentes/llenarSelectMarca.php',
			type: "POST",
			data: "submit=&condicion="+condicion+"&seleccionado="+seleccionado, //Pasamos los datos en forma de array seralizado desde la funcion de envio
			success: function(mensaje){
				$("#idmarca_ajax").html(mensaje);
			}
		});
		return false;
}
function llenarChecksProveedores(seleccionado,condicion){
...
function llenarSelect(campo,condicion){
		var seleccionado=window[campo+"Seleccionado"];
		$("#c"+campo).html("<option value='1'>cargando...</option>");
		$.ajax({
			url: '../componentes/llenarSelect.php',
			type: "POST",
			data: "submit=&condicion="+condicion+"&campo="+campo+"&seleccionado="+seleccionado, //Pasamos los datos en forma de array seralizado desde la funcion de envio
			success: function(mensaje){
