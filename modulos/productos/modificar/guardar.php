...
if($validacion){
	$resultado=$Oproducto->actualizar($idfamilia,$nombre,$codigo,$autoclasificar,$clasificacion,$idmodeloimpuestos,$idcategoria,$idunidad,$marca,$pesoteorico,$espesor,$ancho,$color,$diametro,$tipo,$modelo,$modelo2,$lado,$alto,$largo,$aplicacion,$clave,$descripcion,$variacionpermitidaencosto,$proveedores,$claves,$costo,$estatus,$idproducto);
	if($resultado=="exito"){
