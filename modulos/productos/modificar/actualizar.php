...
<html>
  <head>
	...
	<script><?php echo "var idproductoSeleccionado='$id';";?></script>
    <script><?php echo "var Gcampos='$Gcampos';";?></script>
    <script><?php echo "var idfamiliaSeleccionada='$idfamilia';";?></script>
    <script><?php echo "var espesorSeleccionado='$espesor';";?></script>
    <script><?php echo "var pesoteoricoSeleccionado='$pesoteorico';";?></script>
    <script><?php echo "var anchoSeleccionado='$ancho';";?></script>
    <script><?php echo "var colorSeleccionado='$color';";?></script>
    <script><?php echo "var diametroSeleccionado='$diametro';";?></script>
    <script><?php echo "var ladoSeleccionado='$lado';";?></script>
    <script><?php echo "var tipoSeleccionado='$tipo';";?></script>
    <script><?php echo "var marcaSeleccionado='$marca';";?></script>
    <script><?php echo "var altoSeleccionado='$alto';";?></script>
    <script><?php echo "var aplicacionSeleccionado='$aplicacion';";?></script>
    <script><?php echo "var modeloSeleccionado='$modelo';";?></script>
    <script><?php echo "var modelo2Seleccionado='$modelo2';";?></script>
    <script><?php echo "var largoSeleccionado='$largo';";?></script>
    <script><?php echo "var claveSeleccionado='$clave';";?></script>
            ...
            <div class="box box-info" style="border-color:#494441">
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
                ...
                <div class="form-group hide">
                    ...
                    <div class="col-sm-5">
                        <input value="<?php echo $idfamilia?>" name="idfamilia" type="text" class="form-control" id="cidfamilia" />
                    </div>
                </div>
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-8">
                    	<span id="Vnombre">
                        <input value="<?php echo $nombre; ?>" name="nombre" type="text" class="form-control" id="cnombre" readonly/>
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-10">
                    	<label>
							<?php 
								$checked="";
								if($autoclasificar=="si"){
									$checked="checked='checked'";
								}
							?>
                  			<input id="cautoclasificar" type="checkbox" name="autoclasificar" value="si" <?php echo $checked; ?>>
                  			Auto clasificar ABC
                 		</label>
                    </div>
                </div>
                ...
                <div class="form-group hide">
                    ...
                    <div class="col-sm-2">
                      <input type="text" class="form-control" name="costo" id="ccosto" value="<?php echo $costo?>">
                    </div> 
                </div>
                ...
                <div class="form-group ">
                    <label for="cidcategoria" class="col-sm-2 control-label">Categoría:</label>
                    <div class="col-sm-5">
						<input value="<?php echo $idcategoria; ?>" name="idcategoria" type="hidden" class="normal" id="cidcategoria" style="width:50px;"/>
						<input value="" name="consultaidcategoria" name="consultaidcategoria" type="hidden" class="normal" id="consultaidcategoria" style="width:100px;"/>
						<input value="<?php echo $autoidcategoria; ?>" name="autoidcategoria" type="text" class="form-control" id="autoidcategoria" />
                    </div>
                </div>
				...
				<div class="form-group Lpesoteorico" style="display:none;">
                    ...
                    <div class="col-sm-2">
                        <input value="<?php echo $pesoteorico?>" name="pesoteorico" type="text" class="form-control cpesoteorico" id="cpesoteorico" onChange="agregarDescripcion()"/>
                    </div>
                </div>
				...
				<div class="form-group Lclave" style="display:none;">
                    ...
                    <div class="col-sm-2">
                        <input value="<?php echo $clave?>" name="clave" type="text" class="form-control cclave" id="cclave" onChange="agregarDescripcion()"/>
                    </div>
                </div>
				...
				<div class="form-group Lmodelo" style="display:none;">
                    ...
                    <div class="col-sm-3">
                        <input value="<?php echo $modelo?>" name="modelo" type="text" class="form-control cmodelo" id="cmodelo" onChange="agregarDescripcion()"/>
                    </div>
                </div>
                ...
                <div class="form-group Lmodelo2" style="display:none;">
                    ...
                    <div class="col-sm-3">
                        <input value="<?php echo $modelo2?>" name="modelo2" type="text" class="form-control cmodelo2" id="cmodelo2" onChange="agregarDescripcion()"/>
                    </div>
                </div>
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-5">
                    	<select id="cvariacionpermitidaencosto" name="variacionpermitidaencosto" class="form-control">
										<option value="1" <?php 
											if ($variacionpermitidaencosto=="1"){
												echo 'selected="selected"';
											}
											 ?>>1%</option>
                ...
                <div class="box-footer">
				  <input name="idproducto" type="hidden" id="cidproducto" value="<?php echo $id;?>"/>
