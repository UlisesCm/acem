          ...
          <ul class="dropdown-menu dropdown-menu-form" style="min-width:250px;;">
            ...
            <li><a>
            	<select id="campoOrden" class="form-control input-sm">
									...
									<option value="domiciliocompleto">Domicilio fiscal</option>
									<option value="formapago">Forma de pago</option>
									<option value="metodopago">Método de pago</option>
									<option value="usocfdi">Uso de CFDI</option>
                </select>
                </a>
    		</li>
            ...
            <li><span class="titulo-herramientas">Mostrar / Ocultar campos</span></li>
				...
				<li><a><input id="CheckDomiciliocompleto" name="kdomiciliocompleto" value="si" checked="checked" type="checkbox"/><label for="CheckDomiciliocompleto">&nbsp;&nbsp;Domiciliocompleto</label></a></li>
			
				<li><a><input id="CheckMetodopago" name="kmetodopago" value="si" checked="checked" type="checkbox"/><label for="CheckMetodopago">&nbsp;&nbsp;Metodopago</label></a></li>
			
				<li><a><input id="CheckUsocfdi" name="kusocfdi" value="si" checked="checked" type="checkbox"/><label for="CheckUsocfdi">&nbsp;&nbsp;Usocfdi</label></a></li>
