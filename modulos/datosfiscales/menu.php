		...
		<ul>
			...
			<li>
				<div class="tituloMenu">
					<div id="labelMenu">datosfiscales</div>
				</div>
			</li>
			<?php
			/////PERMISOS////////////////
			...
			<li>
				...
				<div id="labelMenu">Nuevo datofiscal</div>
				</a>
			</li>
			<?php }?>
			...
			<li>
				...
				<div id="labelMenu">Consultar datosfiscales</div>
				</a>
			</li>
			<?php }?>
			<?php
			...
			<li>
				...
				<div id="labelMenu">Papelera de datosfiscales</div>
				</a>
			</li>
			<?php }?>
