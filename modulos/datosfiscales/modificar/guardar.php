...
if (isset($_POST['iddatofiscal'])){
	$iddatofiscal=htmlentities(trim($_POST['iddatofiscal']));
	//$iddatofiscal=mysql_real_escape_string($iddatofiscal);
}else{
	$validacion=false;
	$mensaje=$mensaje."<p>El campo iddatofiscal no es correcto</p>";
}
...
if($validacion){
	$resultado=$Odatofiscal->actualizar($idcliente,$domiciliocompleto,$formapago,$metodopago,$usocfdi,$estatus, $iddatofiscal);
	if($resultado=="exito"){
