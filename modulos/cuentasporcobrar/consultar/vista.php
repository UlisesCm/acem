    ...
    <div class="wrapper s">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Ventas<small> Consulta</small>
          </h1>
          <ol class="breadcrumb">
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['cuentasporcobrar']['consultar']) or  !isset($_SESSION['permisos']['cuentasporcobrar']['acceso'])){
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
                <div class="box-body">
                	<div class='row' style="padding-left:20px; padding-right:20px; padding-bottom:0px; margin-bottom:0px;">
                    	<div class='col-sm-2'>
                            <div class="form-group">
                            	...
                            	<select id="idsucursal_ajax" name="idsucursal" class="form-control" style="margin-top:2px;">
                            	</select>
                            </div>
                         </div>
                         <div class='col-sm-2'>
                            <div class="form-group">
                            	<label for="idserie_ajax">Serie:</label>
                            	<select id="idserie_ajax" name="serie" class="form-control" style="margin-top:2px;">
                            	</select>
                                 <input value="TODOS" name="tiposerie" type="hidden" class="form-control" id="tiposerie" />
                            </div>
                         </div>
                        <div class='col-sm-2'>
                            <div class="form-group">
                           		<label for="cfolio" class="col-sm-1 control-label">Folio:</label>
                            	<input value="" name="folio" type="text" class="form-control" id="cticket" />
                           	</div>
                        </div>
                        <div class='col-sm-4'>	
                        	<div class="form-group">
                        ...
                        <div class='col-sm-2'>	
                        	<div class="form-group">
                                <label for="crfccliente" class="col-sm-1 control-label">RFC:</label>
                                <input value="" name="rfccliente" type="hidden" class="normal" id="crfccliente" style="width:50px;"/>
                                <input value="" name="consultarfccliente" type="hidden" class="normal" id="consultarfccliente" style="width:100px;"/>
                                <input value="" name="autorfccliente" type="text" class="form-control" id="autorfccliente" />
                        	</div>
                        </div>
                    ...
                    <div class='row' style="padding-left:20px; padding-right:20px; padding-bottom:0px; margin-bottom:0px;">
                        ...
                        <div class='col-sm-2'>
                            <div class="form-group">
                            	<label for="cfiltrarfecha">Filtrar por fecha: </label>
                            		<select id="cfiltrarfecha" name="filtrarfecha" class="form-control" style="margin-top:2px;">
                    	...
                    	<div class='col-sm-2'>
                            <div class="form-group">
                            	<label for="cfechainicio" class="col-sm-1 control-label">de:</label>
                            	<input value="<?php echo date('Y-m-d');?>" name="fechainicio" type="date" required class="form-control" id="cfechainicio" />
                            </div>
                         </div>
                        <div class='col-sm-2'>
                            <div class="form-group">
                           		<label for="cfechafin" class="col-sm-1 control-label">a:</label>
                         ...
                         <div class='col-sm-2'>
                            <div class="form-group">
                            	...
                            	<select id="estadopago" name="estadopago" class="form-control" style="margin-top:2px;">
                    ...
                    <div class='row' style="padding-left:20px; padding-right:20px; padding-bottom:0px; margin-bottom:0px;"><!-- /.Row -->
                        <div class='col-sm-2 pull-right'>
                            <div class="form-group">
                                    <button type="button" class="btn btn-success pull-right" id="botonFiltrar"><i class="fa fa-filter"></i>&nbsp;&nbsp;&nbsp;Filtrar</button>
                            </div>
                		</div>
                    </div><!-- /.Fin row -->
