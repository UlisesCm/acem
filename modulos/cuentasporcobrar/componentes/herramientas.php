...
if ($herramientas=="consultar"){
	include("../../../componentes/herramientasconsultar.php"); ?>
		...
		?>
        <li class="btn-default border-right" title="Facturar Ventas"><a href="#" class="botonFacturar"><i class="fa fa-file-code-o"></i><span class="visible-xs-inline">&nbsp;&nbsp;Crear notas de credito</span></a></li>
		<li class="btn-default border-right botonFiltrar" title="Filtrar Resultados"><a href="#"><i class="fa fa-filter"></i><span class="visible-xs-inline">&nbsp;&nbsp;Filtrar resultados</span></a></li>
    	<?php
		}
		/////PERMISOS////////////////
