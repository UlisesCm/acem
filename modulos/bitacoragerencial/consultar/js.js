...
orden="DESC";
campoOrden="idbitacoragerencial";
iniciar="0";
cantidadamostrar="20";
paginacion=0;
...
function comprobarReglas(){
	...
	if(recuperarCookie("campoOrdenBitacoragerencial")!=null){
		campoOrden=recuperarCookie("campoOrdenBitacoragerencial");
	...
	if(recuperarCookie("cantidadamostrarBitacoragerencial")!=null){
		cantidadamostrar=recuperarCookie("cantidadamostrarBitacoragerencial");
	...
	if(recuperarCookie("ordenBitacoragerencial")=="asc"){
		orden="ASC"
		$('#asc').attr('checked', true);
		$('#desc').attr('checked', false);
	}else if(recuperarCookie("ordenBitacoragerencial")=="desc"){
		orden="DESC"
	...
	if(recuperarCookie("mostrarFechaBitacoragerencial")=="si"){
		$('.Cfecha').show();
		$('#CheckFecha').attr('checked', true);
	}else if(recuperarCookie("mostrarFechaBitacoragerencial")=="no"){
		$('.Cfecha').hide();
		$('#CheckFecha').attr('checked', false);
	}
	//Mostrar u Ocultar Evento
	if(recuperarCookie("mostrarEventoBitacoragerencial")=="si"){
		$('.Cevento').show();
		$('#CheckEvento').attr('checked', true);
	}else if(recuperarCookie("mostrarEventoBitacoragerencial")=="no"){
		$('.Cevento').hide();
		$('#CheckEvento').attr('checked', false);
	}
	//Mostrar u Ocultar Idusuario
	if(recuperarCookie("mostrarIdusuarioBitacoragerencial")=="si"){
		$('.Cidusuario').show();
		$('#CheckIdusuario').attr('checked', true);
	}else if(recuperarCookie("mostrarIdusuarioBitacoragerencial")=="no"){
		$('.Cidusuario').hide();
		$('#CheckIdusuario').attr('checked', false);
	}
	//Mostrar u Ocultar Idsucursal
	if(recuperarCookie("mostrarIdsucursalBitacoragerencial")=="si"){
		$('.Cidsucursal').show();
		$('#CheckIdsucursal').attr('checked', true);
	}else if(recuperarCookie("mostrarIdsucursalBitacoragerencial")=="no"){
		$('.Cidsucursal').hide();
		$('#CheckIdsucursal').attr('checked', false);
	}
	//Mostrar u Ocultar Archivo
	if(recuperarCookie("mostrarArchivoBitacoragerencial")=="si"){
		$('.Carchivo').show();
		$('#CheckArchivo').attr('checked', true);
	}else if(recuperarCookie("mostrarArchivoBitacoragerencial")=="no"){
		$('.Carchivo').hide();
		$('#CheckArchivo').attr('checked', false);
	}
	//Mostrar u Ocultar Composicion
	if(recuperarCookie("mostrarComposicionBitacoragerencial")=="si"){
		$('.Ccomposicion').show();
		$('#CheckComposicion').attr('checked', true);
	}
	if(recuperarCookie("mostrarComposicionBitacoragerencial")=="no"){
		$('.Ccomposicion').hide();
		$('#CheckComposicion').attr('checked', false);
	}
	
	//Elegir el tipo de vista
	if(recuperarCookie("tipoVistaBitacoragerencial")=="tabla"){
		$('.tipoLista').show();
		$('.tipoTabla').hide();
		tipoVista="tabla";
	}else{
	...
	$( ".tipoTabla" ).click(function() {
    	crearCookie("tipoVistaBitacoragerencial", "tabla");
		tipoVista="tabla";
		$(".tipoLista").show();
		$(".tipoTabla").hide();
	...
	$( ".tipoLista" ).click(function() {
    	crearCookie("tipoVistaBitacoragerencial", "lista");
		tipoVista="lista";
		$(".tipoLista").hide();
		$(".tipoTabla").show();
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
...
$(document).ready(function() {
	...
	$("#campoOrden").change(function(){
		...
		crearCookie("campoOrdenBitacoragerencial", campoOrden);
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
	});
	$("#cantidadamostrar").change(function(){
		cantidadamostrar = this.value;
		crearCookie("cantidadamostrarBitacoragerencial", cantidadamostrar);
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
	});
	$( "#asc" ).click(function() {
    	if ($( "#asc" ).is(':checked')){
			crearCookie("ordenBitacoragerencial", "asc");
			orden="ASC"
			load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
		}
	});
	$( "#desc" ).click(function() {
    	if ($( "#desc" ).is(':checked')){
			crearCookie("ordenBitacoragerencial", "desc");
			orden="DESC"
			load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
		}
	});
	$( "#CheckFecha" ).click(function() {
    	if ($( "#CheckFecha" ).is(':checked')){
			crearCookie("mostrarFechaBitacoragerencial", "si");
			$('.Cfecha').show();
		}else{
			crearCookie("mostrarFechaBitacoragerencial", "no");
			$('.Cfecha').hide();
		}	
	});
	$( "#CheckEvento" ).click(function() {
    	if ($( "#CheckEvento" ).is(':checked')){
			crearCookie("mostrarEventoBitacoragerencial", "si");
			$('.Cevento').show();
		}else{
			crearCookie("mostrarEventoBitacoragerencial", "no");
			$('.Cevento').hide();
		}	
	});
	$( "#CheckIdusuario" ).click(function() {
    	if ($( "#CheckIdusuario" ).is(':checked')){
			crearCookie("mostrarIdusuarioBitacoragerencial", "si");
			$('.Cidusuario').show();
		}else{
			crearCookie("mostrarIdusuarioBitacoragerencial", "no");
			$('.Cidusuario').hide();
		}	
	});
	$( "#CheckIdsucursal" ).click(function() {
    	if ($( "#CheckIdsucursal" ).is(':checked')){
			crearCookie("mostrarIdsucursalBitacoragerencial", "si");
			$('.Cidsucursal').show();
		}else{
			crearCookie("mostrarIdsucursalBitacoragerencial", "no");
			$('.Cidsucursal').hide();
		}	
	});
	$( "#CheckArchivo" ).click(function() {
    	if ($( "#CheckArchivo" ).is(':checked')){
			crearCookie("mostrarArchivoBitacoragerencial", "si");
			$('.Carchivo').show();
		}else{
			crearCookie("mostrarArchivoBitacoragerencial", "no");
			$('.Carchivo').hide();
		}	
	});
	$( "#CheckComposicion" ).click(function() {
    	if ($( "#CheckComposicion" ).is(':checked')){
			crearCookie("mostrarComposicionBitacoragerencial", "si");
			$('.Ccomposicion').show();
		}else{
			crearCookie("mostrarComposicionBitacoragerencial", "no");
			$('.Ccomposicion').hide();
		}
	});
