    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Bitacoragerencial<small>Modificar registro</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Modificar bitacoragerencial</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['bitacoragerencial']['modificar']) or  !isset($_SESSION['permisos']['bitacoragerencial']['acceso'])){
            ...
            <div class="box box-info" style="border-color:#9e47a0">
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post" enctype="multipart/form-data" >
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-5">
                    	<span id="Vevento">
                        <textarea name="evento" id="cevento" class="form-control"><?php echo $evento; ?></textarea>
                ...
                <div class="box-footer">
				  <input name="idbitacoragerencial" type="hidden" id="cidbitacoragerencial" value="<?php echo $id;?>"/>
