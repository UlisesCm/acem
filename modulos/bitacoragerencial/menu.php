		...
		<ul>
			...
			<li>
				<div class="tituloMenu">
					<div id="labelMenu">bitacoragerencial</div>
				</div>
			</li>
			<?php
			/////PERMISOS////////////////
			...
			<li>
				...
				<div id="labelMenu">Nuevo bitacoragerencial</div>
				</a>
			</li>
			<?php }?>
			...
			<li>
				...
				<div id="labelMenu">Consultar bitacoragerencial</div>
				</a>
			</li>
			<?php }?>
			<?php
			...
			<li>
				...
				<div id="labelMenu">Papelera de bitacoragerencial</div>
				</a>
			</li>
			<?php }?>
