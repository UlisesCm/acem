...
function comprobarReglas(){
	...
	$( ".tipoTabla" ).click(function() {
		...
		$(".tipoLista").show();
		$(".tipoTabla").hide();
		load_tablas(idalmacen,idproducto);
	});
...
// Onixbm 2014
function load_tablas (idalmacen, idproducto){
	//alert (orden);
	//alert (campoOrden);
	//alert (limit);
	...
	xmlhttp.open("POST","consultar.php?idproducto="+idproducto+"&idalmacen="+idalmacen, true);
	xmlhttp.send();
}
