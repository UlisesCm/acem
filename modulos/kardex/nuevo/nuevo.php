    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Kardex<small>Nuevo registro</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Nuevo kardex</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['kardex']['guardar']) or  !isset($_SESSION['permisos']['kardex']['acceso'])){
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input value="<?php echo date('Y-m-d'); ?>" name="fechamovimiento" type="date" required="required" class="form-control" id="cfechamovimiento" />
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input value="" name="entrada" type="text" class="form-control" id="centrada" />
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input value="" name="salida" type="text" class="form-control" id="csalida" />
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input value="" name="costounitario" type="text" class="form-control" id="ccostounitario" />
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input value="" name="debe" type="text" class="form-control" id="cdebe" />
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input value="" name="haber" type="text" class="form-control" id="chaber" />
