...
if($validacion){
	$resultado=$Okardex->guardar($idproducto,$fechamovimiento,$descripcion,$observaciones,$entrada,$salida,$existencia,$costounitario,$promedio,$debe,$haber,$saldo,$idalmacen,$idmovimiento,$idreferencia,$estatus);
	if($resultado=="exito"){
