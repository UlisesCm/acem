    ...
    <nav style="padding-left:0; margin-left:0px;">
		...
		<ul>
			...
			<li>
				...
				<div id="labelMenu">Nuevo kardex</div>
				</a>
			</li>
			<?php }?>
			...
			<li>
				...
				<div id="labelMenu">Consultar kardex</div>
				</a>
			</li>
			<?php }?>
			<?php
			/////PERMISOS////////////////
			if (isset($_SESSION['permisos']['kardex']['papelera'])){
			?>
			<li>
				...
				<div id="labelMenu">Papelera de kardex</div>
				</a>
			</li>
			<?php }?>
