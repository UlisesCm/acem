...
<?php 
	...
	echo '<script>var idsucursal="'.$_POST['idsucursal'].'";</script>';
	echo '<script>var idproducto="'.$_POST['idproducto'].'";</script>';
	echo '<script>var idalmacenSeleccionado="'.$_POST['idsucursal'].'";</script>';
