...
<script> var idprodcuto=<?php echo $_POST["idprodcuto"];?></script>
<script> var idsucursal=<?php echo $_POST["idsucursal"];?></script>
    ...
    <div class="wrapper s">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Kardex<small> Consulta</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Consultar kardex</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['kardex']['consultar']) or  !isset($_SESSION['permisos']['kardex']['acceso'])){
