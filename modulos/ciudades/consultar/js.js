...
function comprobarReglas(){
	...
	if(recuperarCookie("campoOrdenCiudad")!=null){
		campoOrden=recuperarCookie("campoOrdenCiudad");
	...
	if(recuperarCookie("cantidadamostrarCiudad")!=null){
		cantidadamostrar=recuperarCookie("cantidadamostrarCiudad");
	...
	if(recuperarCookie("ordenCiudad")=="asc"){
		orden="ASC"
		$('#asc').attr('checked', true);
		$('#desc').attr('checked', false);
	}else if(recuperarCookie("ordenCiudad")=="desc"){
		orden="DESC"
	...
	//Mostrar u Ocultar Idciudad
	if(recuperarCookie("mostrarIdciudadCiudad")=="si"){
		$('.Cidciudad').show();
		$('#CheckIdciudad').attr('checked', true);
	}else if(recuperarCookie("mostrarIdciudadCiudad")=="no"){
		$('.Cidciudad').hide();
		$('#CheckIdciudad').attr('checked', false);
	}
	//Mostrar u Ocultar Nombre
	if(recuperarCookie("mostrarNombreCiudad")=="si"){
		$('.Cnombre').show();
		$('#CheckNombre').attr('checked', true);
	}else if(recuperarCookie("mostrarNombreCiudad")=="no"){
		$('.Cnombre').hide();
		$('#CheckNombre').attr('checked', false);
	}
	//Mostrar u Ocultar Idestado
	if(recuperarCookie("mostrarIdestadoCiudad")=="si"){
		$('.Cidestado').show();
		$('#CheckIdestado').attr('checked', true);
	}else if(recuperarCookie("mostrarIdestadoCiudad")=="no"){
		$('.Cidestado').hide();
		$('#CheckIdestado').attr('checked', false);
	}
	//Mostrar u Ocultar Composicion
	if(recuperarCookie("mostrarComposicionCiudad")=="si"){
		$('.Ccomposicion').show();
		$('#CheckComposicion').attr('checked', true);
	}
	if(recuperarCookie("mostrarComposicionCiudad")=="no"){
		$('.Ccomposicion').hide();
		$('#CheckComposicion').attr('checked', false);
	}
	
	//Elegir el tipo de vista
	if(recuperarCookie("tipoVistaCiudad")=="tabla"){
		$('.tipoLista').show();
		$('.tipoTabla').hide();
		tipoVista="tabla";
	}else{
	...
	$( ".tipoTabla" ).click(function() {
    	crearCookie("tipoVistaCiudad", "tabla");
		tipoVista="tabla";
		$(".tipoLista").show();
		$(".tipoTabla").hide();
	...
	$( ".tipoLista" ).click(function() {
    	crearCookie("tipoVistaCiudad", "lista");
		tipoVista="lista";
		$(".tipoLista").hide();
		$(".tipoTabla").show();
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
...
$(document).ready(function() {
	...
	$("#campoOrden").change(function(){
		...
		crearCookie("campoOrdenCiudad", campoOrden);
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
	});
	$("#cantidadamostrar").change(function(){
		cantidadamostrar = this.value;
		crearCookie("cantidadamostrarCiudad", cantidadamostrar);
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
	});
	$( "#asc" ).click(function() {
    	if ($( "#asc" ).is(':checked')){
			crearCookie("ordenCiudad", "asc");
			orden="ASC"
			load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
		}
	});
	$( "#desc" ).click(function() {
    	if ($( "#desc" ).is(':checked')){
			crearCookie("ordenCiudad", "desc");
			orden="DESC"
			load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
		}
	});
	$( "#CheckIdciudad" ).click(function() {
    	if ($( "#CheckIdciudad" ).is(':checked')){
			crearCookie("mostrarIdciudadCiudad", "si");
			$('.Cidciudad').show();
		}else{
			crearCookie("mostrarIdciudadCiudad", "no");
			$('.Cidciudad').hide();
		}	
	});
	$( "#CheckNombre" ).click(function() {
    	if ($( "#CheckNombre" ).is(':checked')){
			crearCookie("mostrarNombreCiudad", "si");
			$('.Cnombre').show();
		}else{
			crearCookie("mostrarNombreCiudad", "no");
			$('.Cnombre').hide();
		}	
	});
	$( "#CheckIdestado" ).click(function() {
    	if ($( "#CheckIdestado" ).is(':checked')){
			crearCookie("mostrarIdestadoCiudad", "si");
			$('.Cidestado').show();
		}else{
			crearCookie("mostrarIdestadoCiudad", "no");
			$('.Cidestado').hide();
		}	
	});
	$( "#CheckComposicion" ).click(function() {
    	if ($( "#CheckComposicion" ).is(':checked')){
			crearCookie("mostrarComposicionCiudad", "si");
			$('.Ccomposicion').show();
		}else{
			crearCookie("mostrarComposicionCiudad", "no");
			$('.Ccomposicion').hide();
		}
	});
