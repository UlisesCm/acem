...
$(document).ready(function() {
	...
	llenarSelectEstado(idestadoSeleccionado,"");
...
function buscar (busqueda){
	location.href='../consultar/vista.php?link=vista&busqueda='+busqueda+'&n1=ciudades&n2=consultarciudades';
}

function llenarSelectEstado(seleccionado,condicion){
		$("#idestado_ajax").html("<option value='1'>cargando...</option>");
		$.ajax({
