...
if (isset($_POST['idbitacoracontrol'])){
	$idbitacoracontrol=htmlentities(trim($_POST['idbitacoracontrol']));
	//$idbitacoracontrol=mysql_real_escape_string($idbitacoracontrol);
}else{
	$validacion=false;
	$mensaje=$mensaje."<p>El campo idbitacoracontrol no es correcto</p>";
}
...
if($validacion){
	$resultado=$Obitacoracontrol->actualizar($fecha,$hora,$idusuario,$modulo,$accion,$descripcion,$idregistro,$tabla, $idbitacoracontrol);
	if($resultado=="exito"){
