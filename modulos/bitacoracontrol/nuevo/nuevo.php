    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Bitacoracontrol<small>Nuevo registro</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Nuevo bitacoracontrol</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['bitacoracontrol']['guardar']) or  !isset($_SESSION['permisos']['bitacoracontrol']['acceso'])){
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input value="" name="hora" type="text" class="form-control" id="chora" />
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input value="" name="idusuario" type="text" class="form-control" id="cidusuario" />
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input value="" name="modulo" type="text" class="form-control" id="cmodulo" />
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input value="" name="accion" type="text" class="form-control" id="caccion" />
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input value="" name="tabla" type="text" class="form-control" id="ctabla" />
