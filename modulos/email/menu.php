    ...
    <nav style="padding-left:0; margin-left:0px;">
		...
		<ul>
			...
			<li>
				...
				<div id="labelMenu">Nuevo marca</div>
				</a>
			</li>
			<?php }?>
			...
			<li>
				...
				<div id="labelMenu">Consultar marcas</div>
				</a>
			</li>
			<?php }?>
			<?php
			/////PERMISOS////////////////
			if (isset($_SESSION['permisos']['marcas']['papelera'])){
			?>
			<li>
				...
				<div id="labelMenu">Papelera de marcas</div>
				</a>
			</li>
			<?php }?>
