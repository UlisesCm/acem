          ...
          <ul class="dropdown-menu dropdown-menu-form" style="min-width:250px;;">
            ...
            <li><a>
            	<select id="campoOrden" class="form-control input-sm">
									...
									<option value="idcuentaprincipal">Cuenta principal</option>
                </select>
                </a>
    		</li>
            ...
            <li><span class="titulo-herramientas">Mostrar / Ocultar campos</span></li>
				...
				<li><a><input id="CheckIdcuentaprincipal" name="kidcuentaprincipal" value="si" checked="checked" type="checkbox"/><label for="CheckIdcuentaprincipal">&nbsp;&nbsp;Idcuentaprincipal</label></a></li>
