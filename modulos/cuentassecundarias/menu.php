		...
		<ul>
			...
			<li>
				<div class="tituloMenu">
					<div id="labelMenu">cuentassecundarias</div>
				</div>
			</li>
			<?php
			/////PERMISOS////////////////
			...
			<li>
				...
				<div id="labelMenu">Nuevo cuentasecundaria</div>
				</a>
			</li>
			<?php }?>
			...
			<li>
				...
				<div id="labelMenu">Consultar cuentassecundarias</div>
				</a>
			</li>
			<?php }?>
			<?php
			...
			<li>
				...
				<div id="labelMenu">Papelera de cuentassecundarias</div>
				</a>
			</li>
			<?php }?>
