...
function comprobarReglas(){
	...
	if(recuperarCookie("campoOrdenCuentasecundaria")!=null){
		campoOrden=recuperarCookie("campoOrdenCuentasecundaria");
	...
	if(recuperarCookie("cantidadamostrarCuentasecundaria")!=null){
		cantidadamostrar=recuperarCookie("cantidadamostrarCuentasecundaria");
	...
	if(recuperarCookie("ordenCuentasecundaria")=="asc"){
		orden="ASC"
		$('#asc').attr('checked', true);
		$('#desc').attr('checked', false);
	}else if(recuperarCookie("ordenCuentasecundaria")=="desc"){
		orden="DESC"
	...
	if(recuperarCookie("mostrarNombreCuentasecundaria")=="si"){
		$('.Cnombre').show();
		$('#CheckNombre').attr('checked', true);
	}else if(recuperarCookie("mostrarNombreCuentasecundaria")=="no"){
		$('.Cnombre').hide();
		$('#CheckNombre').attr('checked', false);
	}
	//Mostrar u Ocultar Idcuentaprincipal
	if(recuperarCookie("mostrarIdcuentaprincipalCuentasecundaria")=="si"){
		$('.Cidcuentaprincipal').show();
		$('#CheckIdcuentaprincipal').attr('checked', true);
	}else if(recuperarCookie("mostrarIdcuentaprincipalCuentasecundaria")=="no"){
		$('.Cidcuentaprincipal').hide();
		$('#CheckIdcuentaprincipal').attr('checked', false);
	}
	//Mostrar u Ocultar Composicion
	if(recuperarCookie("mostrarComposicionCuentasecundaria")=="si"){
		$('.Ccomposicion').show();
		$('#CheckComposicion').attr('checked', true);
	}
	if(recuperarCookie("mostrarComposicionCuentasecundaria")=="no"){
		$('.Ccomposicion').hide();
		$('#CheckComposicion').attr('checked', false);
	}
	
	//Elegir el tipo de vista
	if(recuperarCookie("tipoVistaCuentasecundaria")=="tabla"){
		$('.tipoLista').show();
		$('.tipoTabla').hide();
		tipoVista="tabla";
	}else{
	...
	$( ".tipoTabla" ).click(function() {
    	crearCookie("tipoVistaCuentasecundaria", "tabla");
		tipoVista="tabla";
		$(".tipoLista").show();
		$(".tipoTabla").hide();
	...
	$( ".tipoLista" ).click(function() {
    	crearCookie("tipoVistaCuentasecundaria", "lista");
		tipoVista="lista";
		$(".tipoLista").hide();
		$(".tipoTabla").show();
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
...
$(document).ready(function() {
	...
	$("#campoOrden").change(function(){
		...
		crearCookie("campoOrdenCuentasecundaria", campoOrden);
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
	});
	$("#cantidadamostrar").change(function(){
		cantidadamostrar = this.value;
		crearCookie("cantidadamostrarCuentasecundaria", cantidadamostrar);
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
	});
	$( "#asc" ).click(function() {
    	if ($( "#asc" ).is(':checked')){
			crearCookie("ordenCuentasecundaria", "asc");
			orden="ASC"
			load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
		}
	});
	$( "#desc" ).click(function() {
    	if ($( "#desc" ).is(':checked')){
			crearCookie("ordenCuentasecundaria", "desc");
			orden="DESC"
			load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
		}
	});
	$( "#CheckNombre" ).click(function() {
    	if ($( "#CheckNombre" ).is(':checked')){
			crearCookie("mostrarNombreCuentasecundaria", "si");
			$('.Cnombre').show();
		}else{
			crearCookie("mostrarNombreCuentasecundaria", "no");
			$('.Cnombre').hide();
		}	
	});
	$( "#CheckIdcuentaprincipal" ).click(function() {
    	if ($( "#CheckIdcuentaprincipal" ).is(':checked')){
			crearCookie("mostrarIdcuentaprincipalCuentasecundaria", "si");
			$('.Cidcuentaprincipal').show();
		}else{
			crearCookie("mostrarIdcuentaprincipalCuentasecundaria", "no");
			$('.Cidcuentaprincipal').hide();
		}	
	});
	$( "#CheckComposicion" ).click(function() {
    	if ($( "#CheckComposicion" ).is(':checked')){
			crearCookie("mostrarComposicionCuentasecundaria", "si");
			$('.Ccomposicion').show();
		}else{
			crearCookie("mostrarComposicionCuentasecundaria", "no");
			$('.Ccomposicion').hide();
		}
	});
