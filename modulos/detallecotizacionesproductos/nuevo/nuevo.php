    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Detallecotizacionproducto<small>Nuevo registro</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Nuevo detallecotizacionproducto</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['detallecotizacionesproductos']['guardar']) or  !isset($_SESSION['permisos']['detallecotizacionesproductos']['acceso'])){
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input value="" name="subfolio" type="text" class="form-control" id="csubfolio" />
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input value="" name="costo" type="text" class="form-control" id="ccosto" />
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input value="" name="idcotizacionproducto" type="text" class="form-control" id="cidcotizacionproducto" />
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input value="" name="pesounitario" type="text" class="form-control" id="cpesounitario" />
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input value="" name="cantidadentregada" type="text" class="form-control" id="ccantidadentregada" />
