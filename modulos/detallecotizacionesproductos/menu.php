		...
		<ul>
			...
			<li>
				<div class="tituloMenu">
					<div id="labelMenu">detallecotizacionesproductos</div>
				</div>
			</li>
			<?php
			/////PERMISOS////////////////
			...
			<li>
				...
				<div id="labelMenu">Nuevo detallecotizacionproducto</div>
				</a>
			</li>
			<?php }?>
			...
			<li>
				...
				<div id="labelMenu">Consultar detallecotizacionesproductos</div>
				</a>
			</li>
			<?php }?>
