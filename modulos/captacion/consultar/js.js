...
function comprobarReglas(){
	...
	if(recuperarCookie("campoOrdenCaptacion")!=null){
		campoOrden=recuperarCookie("campoOrdenCaptacion");
	...
	if(recuperarCookie("cantidadamostrarCaptacion")!=null){
		cantidadamostrar=recuperarCookie("cantidadamostrarCaptacion");
	...
	if(recuperarCookie("ordenCaptacion")=="asc"){
		orden="ASC"
		$('#asc').attr('checked', true);
		$('#desc').attr('checked', false);
	}else if(recuperarCookie("ordenCaptacion")=="desc"){
		orden="DESC"
	...
	//Mostrar u Ocultar Idcaptacion
	if(recuperarCookie("mostrarIdcaptacionCaptacion")=="si"){
		$('.Cidcaptacion').show();
		$('#CheckIdcaptacion').attr('checked', true);
	}else if(recuperarCookie("mostrarIdcaptacionCaptacion")=="no"){
		$('.Cidcaptacion').hide();
		$('#CheckIdcaptacion').attr('checked', false);
	}
	//Mostrar u Ocultar Nombre
	if(recuperarCookie("mostrarNombreCaptacion")=="si"){
		$('.Cnombre').show();
		$('#CheckNombre').attr('checked', true);
	}else if(recuperarCookie("mostrarNombreCaptacion")=="no"){
		$('.Cnombre').hide();
		$('#CheckNombre').attr('checked', false);
	}
	//Mostrar u Ocultar Composicion
	if(recuperarCookie("mostrarComposicionCaptacion")=="si"){
		$('.Ccomposicion').show();
		$('#CheckComposicion').attr('checked', true);
	}
	if(recuperarCookie("mostrarComposicionCaptacion")=="no"){
		$('.Ccomposicion').hide();
		$('#CheckComposicion').attr('checked', false);
	}
	
	//Elegir el tipo de vista
	if(recuperarCookie("tipoVistaCaptacion")=="tabla"){
		$('.tipoLista').show();
		$('.tipoTabla').hide();
		tipoVista="tabla";
	}else{
	...
	$( ".tipoTabla" ).click(function() {
    	crearCookie("tipoVistaCaptacion", "tabla");
		tipoVista="tabla";
		$(".tipoLista").show();
		$(".tipoTabla").hide();
	...
	$( ".tipoLista" ).click(function() {
    	crearCookie("tipoVistaCaptacion", "lista");
		tipoVista="lista";
		$(".tipoLista").hide();
		$(".tipoTabla").show();
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
...
$(document).ready(function() {
	...
	$("#campoOrden").change(function(){
		...
		crearCookie("campoOrdenCaptacion", campoOrden);
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
	});
	$("#cantidadamostrar").change(function(){
		cantidadamostrar = this.value;
		crearCookie("cantidadamostrarCaptacion", cantidadamostrar);
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
	});
	$( "#asc" ).click(function() {
    	if ($( "#asc" ).is(':checked')){
			crearCookie("ordenCaptacion", "asc");
			orden="ASC"
			load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
		}
	});
	$( "#desc" ).click(function() {
    	if ($( "#desc" ).is(':checked')){
			crearCookie("ordenCaptacion", "desc");
			orden="DESC"
			load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
		}
	});
	$( "#CheckIdcaptacion" ).click(function() {
    	if ($( "#CheckIdcaptacion" ).is(':checked')){
			crearCookie("mostrarIdcaptacionCaptacion", "si");
			$('.Cidcaptacion').show();
		}else{
			crearCookie("mostrarIdcaptacionCaptacion", "no");
			$('.Cidcaptacion').hide();
		}	
	});
	$( "#CheckNombre" ).click(function() {
    	if ($( "#CheckNombre" ).is(':checked')){
			crearCookie("mostrarNombreCaptacion", "si");
			$('.Cnombre').show();
		}else{
			crearCookie("mostrarNombreCaptacion", "no");
			$('.Cnombre').hide();
		}	
	});
	$( "#CheckComposicion" ).click(function() {
    	if ($( "#CheckComposicion" ).is(':checked')){
			crearCookie("mostrarComposicionCaptacion", "si");
			$('.Ccomposicion').show();
		}else{
			crearCookie("mostrarComposicionCaptacion", "no");
			$('.Ccomposicion').hide();
		}
	});
