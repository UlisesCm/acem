		...
		<ul>
			...
			<li>
				<div class="tituloMenu">
					<div id="labelMenu">captacion</div>
				</div>
			</li>
			<?php
			/////PERMISOS////////////////
			if (isset($_SESSION['permisos']['captacion']['guardar'])){
			?>
			<li>
				<a href="../nuevo/nuevo.php?link=nuevo" <?php botonActivo("nuevo");?>>
				<div id="iconoMenu"><img src="../../../css/imagenes/add.png"/></div>
				<div id="labelMenu">Nuevo captacion</div>
				</a>
			</li>
			<?php }?>
			...
			<?php
			/////PERMISOS////////////////
			if (isset($_SESSION['permisos']['captacion']['consultar'])){
			?>
			<li>
				<a href="../consultar/vista.php?link=vista" <?php botonActivo("vista");?>>
				<div id="iconoMenu"><img src="../../../css/imagenes/consultar.png"/></div>
				<div id="labelMenu">Consultar captacion</div>
				</a>
			</li>
			<?php }?>
			<?php
			/////PERMISOS////////////////
			if (isset($_SESSION['permisos']['captacion']['papelera'])){
			?>
			<li>
				...
				<div id="labelMenu">Papelera de captacion</div>
				</a>
			</li>
			<?php }?>
