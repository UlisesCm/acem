    ...
    <nav style="padding-left:0; margin-left:0px;">
		...
		<ul>
			...
			<li>
				...
				<div id="labelMenu">Nuevo persona</div>
				</a>
			</li>
			<?php }?>
			...
			<li>
				...
				<div id="labelMenu">Consultar personas</div>
				</a>
			</li>
			<?php }?>
			<?php
			/////PERMISOS////////////////
			if (isset($_SESSION['permisos']['personas']['papelera'])){
			?>
			<li>
				...
				<div id="labelMenu">Papelera de personas</div>
				</a>
			</li>
			<?php }?>
