...
function comprobarReglas(){
	...
	if(recuperarCookie("campoOrdenPersona")!=null){
		campoOrden=recuperarCookie("campoOrdenPersona");
	...
	if(recuperarCookie("cantidadamostrarPersona")!=null){
		cantidadamostrar=recuperarCookie("cantidadamostrarPersona");
	...
	if(recuperarCookie("ordenPersona")=="asc"){
		orden="ASC"
		$('#asc').attr('checked', true);
		$('#desc').attr('checked', false);
	}else if(recuperarCookie("ordenPersona")=="desc"){
		orden="DESC"
	...
	//Mostrar u Ocultar Idpersona
	if(recuperarCookie("mostrarIdpersonaPersona")=="si"){
		$('.Cidpersona').show();
		$('#CheckIdpersona').attr('checked', true);
	}else if(recuperarCookie("mostrarIdpersonaPersona")=="no"){
		$('.Cidpersona').hide();
		$('#CheckIdpersona').attr('checked', false);
	}
	//Mostrar u Ocultar Rfc
	if(recuperarCookie("mostrarRfcPersona")=="si"){
		$('.Crfc').show();
		$('#CheckRfc').attr('checked', true);
	}else if(recuperarCookie("mostrarRfcPersona")=="no"){
		$('.Crfc').hide();
		$('#CheckRfc').attr('checked', false);
	}
	//Mostrar u Ocultar Razonsocial
	if(recuperarCookie("mostrarRazonsocialPersona")=="si"){
		$('.Crazonsocial').show();
		$('#CheckRazonsocial').attr('checked', true);
	}else if(recuperarCookie("mostrarRazonsocialPersona")=="no"){
		$('.Crazonsocial').hide();
		$('#CheckRazonsocial').attr('checked', false);
	}
	//Mostrar u Ocultar Usocfdi
	if(recuperarCookie("mostrarUsocfdiPersona")=="si"){
		$('.Cusocfdi').show();
		$('#CheckUsocfdi').attr('checked', true);
	}else if(recuperarCookie("mostrarUsocfdiPersona")=="no"){
		$('.Cusocfdi').hide();
		$('#CheckUsocfdi').attr('checked', false);
	}
	//Mostrar u Ocultar Email
	if(recuperarCookie("mostrarEmailPersona")=="si"){
		$('.Cemail').show();
		$('#CheckEmail').attr('checked', true);
	}else if(recuperarCookie("mostrarEmailPersona")=="no"){
		$('.Cemail').hide();
		$('#CheckEmail').attr('checked', false);
	}
	//Mostrar u Ocultar Mensaje
	if(recuperarCookie("mostrarMensajePersona")=="si"){
		$('.Cmensaje').show();
		$('#CheckMensaje').attr('checked', true);
	}else if(recuperarCookie("mostrarMensajePersona")=="no"){
		$('.Cmensaje').hide();
		$('#CheckMensaje').attr('checked', false);
	}
	//Mostrar u Ocultar Composicion
	if(recuperarCookie("mostrarComposicionPersona")=="si"){
		$('.Ccomposicion').show();
		$('#CheckComposicion').attr('checked', true);
	}
	if(recuperarCookie("mostrarComposicionPersona")=="no"){
		$('.Ccomposicion').hide();
		$('#CheckComposicion').attr('checked', false);
	}
	
	//Elegir el tipo de vista
	if(recuperarCookie("tipoVistaPersona")=="tabla"){
		$('.tipoLista').show();
		$('.tipoTabla').hide();
		tipoVista="tabla";
	}else{
	...
	$( ".tipoTabla" ).click(function() {
    	crearCookie("tipoVistaPersona", "tabla");
		tipoVista="tabla";
		$(".tipoLista").show();
		$(".tipoTabla").hide();
	...
	$( ".tipoLista" ).click(function() {
    	crearCookie("tipoVistaPersona", "lista");
		tipoVista="lista";
		$(".tipoLista").hide();
		$(".tipoTabla").show();
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
...
$(document).ready(function() {
	...
	$("#campoOrden").change(function(){
		...
		crearCookie("campoOrdenPersona", campoOrden);
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
	});
	$("#cantidadamostrar").change(function(){
		cantidadamostrar = this.value;
		crearCookie("cantidadamostrarPersona", cantidadamostrar);
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
	});
	$( "#asc" ).click(function() {
    	if ($( "#asc" ).is(':checked')){
			crearCookie("ordenPersona", "asc");
			orden="ASC"
			load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
		}
	});
	$( "#desc" ).click(function() {
    	if ($( "#desc" ).is(':checked')){
			crearCookie("ordenPersona", "desc");
			orden="DESC"
			load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
		}
	});
	$( "#CheckIdpersona" ).click(function() {
    	if ($( "#CheckIdpersona" ).is(':checked')){
			crearCookie("mostrarIdpersonaPersona", "si");
			$('.Cidpersona').show();
		}else{
			crearCookie("mostrarIdpersonaPersona", "no");
			$('.Cidpersona').hide();
		}	
	});
	$( "#CheckRfc" ).click(function() {
    	if ($( "#CheckRfc" ).is(':checked')){
			crearCookie("mostrarRfcPersona", "si");
			$('.Crfc').show();
		}else{
			crearCookie("mostrarRfcPersona", "no");
			$('.Crfc').hide();
		}	
	});
	$( "#CheckRazonsocial" ).click(function() {
    	if ($( "#CheckRazonsocial" ).is(':checked')){
			crearCookie("mostrarRazonsocialPersona", "si");
			$('.Crazonsocial').show();
		}else{
			crearCookie("mostrarRazonsocialPersona", "no");
			$('.Crazonsocial').hide();
		}	
	});
	$( "#CheckUsocfdi" ).click(function() {
    	if ($( "#CheckUsocfdi" ).is(':checked')){
			crearCookie("mostrarUsocfdiPersona", "si");
			$('.Cusocfdi').show();
		}else{
			crearCookie("mostrarUsocfdiPersona", "no");
			$('.Cusocfdi').hide();
		}	
	});
	$( "#CheckEmail" ).click(function() {
    	if ($( "#CheckEmail" ).is(':checked')){
			crearCookie("mostrarEmailPersona", "si");
			$('.Cemail').show();
		}else{
			crearCookie("mostrarEmailPersona", "no");
			$('.Cemail').hide();
		}	
	});
	$( "#CheckMensaje" ).click(function() {
    	if ($( "#CheckMensaje" ).is(':checked')){
			crearCookie("mostrarMensajePersona", "si");
			$('.Cmensaje').show();
		}else{
			crearCookie("mostrarMensajePersona", "no");
			$('.Cmensaje').hide();
		}	
	});
	$( "#CheckComposicion" ).click(function() {
    	if ($( "#CheckComposicion" ).is(':checked')){
			crearCookie("mostrarComposicionPersona", "si");
			$('.Ccomposicion').show();
		}else{
			crearCookie("mostrarComposicionPersona", "no");
			$('.Ccomposicion').hide();
		}
	});
