...
if ($herramientas=="nuevo"){
	?>
    <li class="btn-default border-right botonSincronizar" title="Sincronizar Productos y Servicios"><a href="#"><i class="fa fa-refresh"></i><span class="visible-xs-inline">&nbsp;&nbsp;Sincronizar Productos y Servicios</span></a></li>
    <?php
...
if ($herramientas=="consultar"){
	 ?>
		...
		?>
        <li class="btn-default border-right botonCargar" title="Cargar lista de precios desde excel"><a href="#"><i class="fa fa-upload"></i><span class="visible-xs-inline">&nbsp;&nbsp;Establecer precios por familia</span></a></li>
        <li class="btn-default border-right botonCondicionar" title="Establecer precios por familia"><a href="#"><i class="fa fa-filter"></i><span class="visible-xs-inline">&nbsp;&nbsp;Establecer precios por familia</span></a></li>
        <li class="btn-default border-right botonSincronizar" title="Sincronizar Productos y Servicios"><a href="#"><i class="fa fa-refresh"></i><span class="visible-xs-inline">&nbsp;&nbsp;Sincronizar Productos y Servicios</span></a></li>
    	<?php
		}
		?>
          ...
          <ul class="dropdown-menu dropdown-menu-form" style="min-width:250px;;">
            ...
            <li><a>
            	<select id="campoOrden" class="form-control input-sm">
									<option value="idlistaprecios">ID</option>
            ...
            <li><span class="titulo-herramientas">Mostrar / Ocultar campos</span></li>
				...
				<li><a><input id="CheckIdlistaprecios" name="kidlistaprecios" value="si" checked="checked" type="checkbox"/><label for="CheckIdlistaprecios">&nbsp;&nbsp;ID</label></a></li>
