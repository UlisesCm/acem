...
function comprobarReglas(){
	...
	if(recuperarCookie("campoOrdenListaprecios")!=null){
		campoOrden=recuperarCookie("campoOrdenListaprecios");
	...
	if(recuperarCookie("cantidadamostrarListaprecios")!=null){
		cantidadamostrar=recuperarCookie("cantidadamostrarListaprecios");
	...
	if(recuperarCookie("ordenListaprecios")=="asc"){
		orden="ASC"
		$('#asc').attr('checked', true);
		$('#desc').attr('checked', false);
	}else if(recuperarCookie("ordenListaprecios")=="desc"){
		orden="DESC"
	...
	//Mostrar u Ocultar Idlistaprecios
	if(recuperarCookie("mostrarIdlistapreciosListaprecios")=="si"){
		$('.Cidlistaprecios').show();
		$('#CheckIdlistaprecios').attr('checked', true);
	}else if(recuperarCookie("mostrarIdlistapreciosListaprecios")=="no"){
		$('.Cidlistaprecios').hide();
		$('#CheckIdlistaprecios').attr('checked', false);
	}
	//Mostrar u Ocultar Nombre
	if(recuperarCookie("mostrarNombreListaprecios")=="si"){
		$('.Cnombre').show();
		$('#CheckNombre').attr('checked', true);
	}else if(recuperarCookie("mostrarNombreListaprecios")=="no"){
		$('.Cnombre').hide();
		$('#CheckNombre').attr('checked', false);
	}
	//Mostrar u Ocultar Composicion
	if(recuperarCookie("mostrarComposicionListaprecios")=="si"){
		$('.Ccomposicion').show();
		$('#CheckComposicion').attr('checked', true);
	}
	if(recuperarCookie("mostrarComposicionListaprecios")=="no"){
		$('.Ccomposicion').hide();
		$('#CheckComposicion').attr('checked', false);
	}
	
	//Elegir el tipo de vista
	if(recuperarCookie("tipoVistaListaprecios")=="tabla"){
		$('.tipoLista').show();
		$('.tipoTabla').hide();
		tipoVista="tabla";
	}else{
	...
	$( ".tipoTabla" ).click(function() {
    	crearCookie("tipoVistaListaprecios", "tabla");
		tipoVista="tabla";
		$(".tipoLista").show();
		$(".tipoTabla").hide();
	...
	$( ".tipoLista" ).click(function() {
    	crearCookie("tipoVistaListaprecios", "lista");
		tipoVista="lista";
		$(".tipoLista").hide();
		$(".tipoTabla").show();
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
