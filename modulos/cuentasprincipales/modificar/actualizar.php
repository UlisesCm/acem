  ...
  <body class="sidebar-mini <?php include("../../../componentes/skin.php");?>">
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Cuentaprincipal<small>Modificar registro</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Modificar cuentaprincipal</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['cuentasprincipales']['modificar']) or  !isset($_SESSION['permisos']['cuentasprincipales']['acceso'])){
	...
	/////FIN  DE PERMISOS////////
			...
			<?php include("../../../componentes/avisos.php");?>
          	...
          	<!-- Horizontal Form -->
            <div class="box box-info" style="border-color:#713878">
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
				...
				<div class="form-group ">
                    <label for="cnombre" class="col-sm-2 control-label">Cuenta:</label>
                    <div class="col-sm-5">
                    	<span id="Vnombre">
				...
				<div class="form-group ">
                    <label for="x" class="col-sm-2 control-label">Tipo:</label>
                    <div class="col-lg-10">
										<label class="radio inline control-label">
										 	<input id="ctipo-0" type="radio" name="tipo" value="INGRESO" <?php 
											if ($tipo=="INGRESO"){
										...
										<label class="radio inline control-label">
										 	<input id="ctipo-1" type="radio" name="tipo" value="EGRESO" <?php 
											if ($tipo=="EGRESO"){
												echo 'checked="checked"';
											} ?> >
											Egreso
                ...
                <div class="box-footer">
				  <input name="idcuentaprincipal" type="hidden" id="cidcuentaprincipal" value="<?php echo $id;?>"/>
                  <button type="button" class="btn btn-default" id="botonCancelar" onclick="vaciarCampos();">Limpiar</button>
                  <button type="button" class="btn btn-primary pull-right" id="botonGuardar"><i class="fa fa-save"></i>&nbsp;&nbsp;&nbsp;Guardar</button>
                </div><!-- /.box-footer -->
              </form>
              <div id="loading" class="overlay" style="display:none">
  					<i class="fa fa-cog fa-spin" style="color:#713878"></i>
			  </div>
