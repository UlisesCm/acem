    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Cuentaprincipal<small>Nuevo registro</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Nuevo cuentaprincipal</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['cuentasprincipales']['guardar']) or  !isset($_SESSION['permisos']['cuentasprincipales']['acceso'])){
				...
				<div class="form-group ">
                    ...
                    <div class="col-lg-10">
										 <label class="radio inline control-label">
										 	<input id="ctipo-0" type="radio" name="tipo" value="INGRESO">
 										 	Ingreso
                        				 </label>
										 <label class="radio inline control-label">
										 	<input id="ctipo-1" type="radio" name="tipo" value="EGRESO">
 										 	Egreso
                        				 </label>
					</div>
				</div>
