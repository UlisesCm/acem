		...
		<ul>
			...
			<li>
				<div class="tituloMenu">
					<div id="labelMenu">cuentasprincipales</div>
				</div>
			</li>
			<?php
			/////PERMISOS////////////////
			...
			<li>
				...
				<div id="labelMenu">Nuevo cuentaprincipal</div>
				</a>
			</li>
			<?php }?>
			...
			<li>
				...
				<div id="labelMenu">Consultar cuentasprincipales</div>
				</a>
			</li>
			<?php }?>
			<?php
			...
			<li>
				...
				<div id="labelMenu">Papelera de cuentasprincipales</div>
				</a>
			</li>
			<?php }?>
