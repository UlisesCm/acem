...
if ($tipoVista=="tabla"){ // Si se ha elegido el tipo tabla ?>
	<div class="box-body table-responsive no-padding"> <!-- /.box-body -->
    	<table class="table table-hover table-bordered">
        	<tr>
				...
				<th class="Ccorreocontacto">Correo contacto</th>
	...
	while ($filas=mysqli_fetch_array($resultado)) { ?>
      		<tr id="iregistro<?php echo $filas['idcliente'] ?>" ondblclick="abrirModal(<?php echo $filas['idcliente'] ?>);">
				...
				<td class="Ccorreocontacto"><?php echo $filas['correocontacto']; ?></td>
...
?>
	<div class="info-box" style="height:120px;" id="iregistro<?php echo $filas['idcliente'] ?>">
    	<span class="info-box-icon bg-red" style="background-color:#3d7698 !important; height:120px; padding-top:15px;"><i class="fa fa-users"></i></span>
    	<div class="info-box-content">
            ...
            <span class="info-box-number Ccomposicion" style="font-weight:normal; font-size:12px;">
				<?php 
				$composicion="";
				if (trim($filas['telefonocontacto'])!=""){
					$composicion=$composicion."Telefono: ".$filas['telefonocontacto'];
				}
				echo $composicion;
				?>
			</span>
