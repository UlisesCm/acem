  ...
  <body class="sidebar-mini <?php include("../../../componentes/skin.php");?>">
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['prospectos']['modificar']) or  !isset($_SESSION['permisos']['prospectos']['acceso'])){
	...
	/////FIN  DE PERMISOS////////
            ...
            <div class="box box-info" style="border-color:#3d7698">
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
                ...
                <div class="form-group ">
                    <label for="cnombre" class="col-sm-2 control-label">Nombre del contacto:</label>
                    <div class="col-sm-5">
