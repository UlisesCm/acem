...
if($validacion){
	...
	if($resultado=="exito"){
		...
		$mensaje=$mensaje."
        		...
        		<form action='../imprimir/consultar.php' method='get' target='_blank'>
            		<input name='Tnic' type='hidden' value='$nic'/>
					<input name='Tnombre' type='hidden' value='$nombre'/>
					<button type='submit' class='btn btn-warning btn-flat'><i class='fa fa-calendar'></i>&nbsp;&nbsp;&nbsp;Agendar Tarea</button>
        		</form>
				</p>
			";
