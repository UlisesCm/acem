  ...
  <body class="sidebar-mini <?php include("../../../componentes/skin.php");?>">
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Prospecto<small>Nuevo registro</small>
          </h1>
          <ol class="breadcrumb">
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['prospectos']['guardar']) or  !isset($_SESSION['permisos']['prospectos']['acceso'])){
	...
	/////FIN  DE PERMISOS////////
			...
			<?php include("../../../componentes/avisos.php");?>
          	...
          	<!-- Horizontal Form -->
            <div class="box box-info" style="border-color:#933">
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
				...
				<div class="form-group ">
                    <label for="cnic" class="col-sm-2 control-label">Nombre Comercial:</label>
                    <div class="col-sm-5">
                ...
                <div class="form-group">
                    <label for="cnombre" class="col-sm-2 control-label">Nombre de contacto:</label>
                    <div class="col-sm-5">
				...
				<div class="form-group hide">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input value="0" name="limitecredito" type="text" class="form-control" id="climitecredito" />
				...
				<div class="form-group hide">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input value="0" name="diascredito" type="text" class="form-control" id="cdiascredito" />
