	...
	while ($filas=mysqli_fetch_array($resultado)) { ?>
      		<tr id="iregistro<?php echo $filas['idperfil'] ?>">
                ...
                <td>
					...
					?>
						<form action="../modificar/actualizar.php?n1=catalogos&n2=usuarios&n3=perfiles&n4=consultarperfiles" method="post">
                ...
                <td>
					...
					?>
						<form action="../permisos/actualizar.php?n1=catalogos&n2=usuarios&n3=perfiles&n4=consultarperfiles" method="post">
							<input type="hidden" name="id" value="<?php echo $filas['idperfil'] ?>"/>
