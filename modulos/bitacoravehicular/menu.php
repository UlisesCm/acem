		...
		<ul>
			...
			<li>
				<div class="tituloMenu">
					<div id="labelMenu">bitacoravehicular</div>
				</div>
			</li>
			<?php
			/////PERMISOS////////////////
			...
			<li>
				...
				<div id="labelMenu">Nuevo bitacoravehicular</div>
				</a>
			</li>
			<?php }?>
			...
			<li>
				...
				<div id="labelMenu">Consultar bitacoravehicular</div>
				</a>
			</li>
			<?php }?>
			<?php
			...
			<li>
				...
				<div id="labelMenu">Papelera de bitacoravehicular</div>
				</a>
			</li>
			<?php }?>
