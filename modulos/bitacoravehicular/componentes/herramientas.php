		...
		<li class="dropdown btn-defaul border-right" style="background:#F4F4F4;" title="Visualización y ordenamiento">
          ...
          <ul class="dropdown-menu dropdown-menu-form" style="min-width:250px;;">
            ...
            <li><span class="titulo-herramientas">Mostrar / Ocultar campos</span></li>
				...
				<li><a><input id="CheckIdbitacoravehicular" name="kidbitacoravehicular" value="si" checked="checked" type="checkbox"/><label for="CheckIdbitacoravehicular">&nbsp;&nbsp;ID</label></a></li>
			
				<li><a><input id="CheckIdvehiculo" name="kidvehiculo" value="si" checked="checked" type="checkbox"/><label for="CheckIdvehiculo">&nbsp;&nbsp;Vehículo</label></a></li>
			
				<li><a><input id="CheckCategoria" name="kcategoria" value="si" checked="checked" type="checkbox"/><label for="CheckCategoria">&nbsp;&nbsp;Categoria</label></a></li>
			
				<li><a><input id="CheckFecha" name="kfecha" value="si" checked="checked" type="checkbox"/><label for="CheckFecha">&nbsp;&nbsp;Fecha</label></a></li>
			
				<li><a><input id="CheckDescripcion" name="kdescripcion" value="si" checked="checked" type="checkbox"/><label for="CheckDescripcion">&nbsp;&nbsp;Descripcion</label></a></li>
			
				<li><a><input id="CheckTipocombustible" name="ktipocombustible" value="si" checked="checked" type="checkbox"/><label for="CheckTipocombustible">&nbsp;&nbsp;Tipo de combustible</label></a></li>
			
				<li><a><input id="CheckLitros" name="klitros" value="si" checked="checked" type="checkbox"/><label for="CheckLitros">&nbsp;&nbsp;Litros</label></a></li>
			
				<li><a><input id="CheckKilometraje" name="kkilometraje" value="si" checked="checked" type="checkbox"/><label for="CheckKilometraje">&nbsp;&nbsp;Kilometraje</label></a></li>
