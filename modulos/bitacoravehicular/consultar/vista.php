    ...
    <div class="wrapper s">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Bitácora Vehicular<small> Consulta</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Consultar Bitacora vehicular</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['bitacoravehicular']['consultar']) or  !isset($_SESSION['permisos']['bitacoravehicular']['acceso'])){
                	...
                	<div class='row' style="padding-left:20px; padding-right:20px; padding-bottom:0px; margin-bottom:0px;">
                        <div class='col-sm-3'>
                            <div class="form-group">
                            	<label for="idvehiculo_ajax">Vehiculo:</label>
                    	...
                    	<div class='col-sm-3'>
                            <div class="form-group">
                            	<label for="cfechainicio">Registros de:</label>
