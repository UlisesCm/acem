...
if($validacion){
	$resultado=$Ovehiculo->actualizar($tipo,$marca,$submarca,$color,$placa,$capacidaddecarga,$anio,$kminicial,$kmactual,$vigenciaseguro,$kmultimomantenimiento,$fechaultimomantenimiento,$tipodecombustible,$frecuenciamantenimientokm,$frecuenciamantenimientofecha,$asignado,$estado,$idempleado,$idsucursal,$estatus, $idvehiculo);
	if($resultado=="exito"){
