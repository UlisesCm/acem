		...
		<ul>
			...
			<li>
				<div class="tituloMenu">
					<div id="labelMenu">detallecotizacionesotros</div>
				</div>
			</li>
			<?php
			/////PERMISOS////////////////
			...
			<li>
				...
				<div id="labelMenu">Nuevo detallecotizacionotro</div>
				</a>
			</li>
			<?php }?>
			...
			<li>
				...
				<div id="labelMenu">Consultar detallecotizacionesotros</div>
				</a>
			</li>
			<?php }?>
			<?php
			...
			<li>
				...
				<div id="labelMenu">Papelera de detallecotizacionesotros</div>
				</a>
			</li>
			<?php }?>
