    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Detallecotizacionotro<small>Nuevo registro</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Nuevo detallecotizacionotro</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['detallecotizacionesotros']['guardar']) or  !isset($_SESSION['permisos']['detallecotizacionesotros']['acceso'])){
            ...
            <div class="box box-info" style="border-color:#b15fb8">
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-2">
                    	<span id="Vcantidad">
                        <input value="" name="cantidad" type="text" class="form-control" id="ccantidad" />
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-5">
                    	<span id="Vconcepto">
                        <textarea name="concepto" id="cconcepto" class="form-control"></textarea>
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-3">
                    	<span id="Vunidad">
                        <input value="" name="unidad" type="text" class="form-control" id="cunidad" />
            			<span class="textfieldMaxCharsMsg">Se ha superado el número máximo de caracteres.</span>
					<span class="textfieldMinCharsMsg">No se cumple el mínimo de caracteres requerido.</span>
						<span class="textfieldRequiredMsg">Se necesita un valor.</span>
					</span>
				...
				<div class="form-group hide">
                    ...
                    <div class="col-sm-2">
                        ...
                        <input value="" name="numeroservicio" type="hidden" class="form-control" id="cnumeroservicio" />
				...
				<div class="form-group hide">
                    ...
                    <div class="col-sm-2">
                        ...
                        <input value="" name="totalservicios" type="hidden" class="form-control" id="ctotalservicios" />
				...
				<div class="form-group hide">
                    ...
                    <div class="col-sm-2">
                        ...
                        <input value="" name="idcotizacionotros" type="hidden" class="form-control" id="cidcotizacionotros" />
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-2">
                        ...
                        <input value="" name="precio" type="text" class="form-control" id="cprecio" />
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-2">
                    	<span id="Vfactura">
                        <input value="" name="factura" type="text" class="form-control" id="cfactura" />
            			<span class="textfieldMaxCharsMsg">Se ha superado el número máximo de caracteres.</span>
					<span class="textfieldMinCharsMsg">No se cumple el mínimo de caracteres requerido.</span>
						<span class="textfieldRequiredMsg">Se necesita un valor.</span>
					</span>
