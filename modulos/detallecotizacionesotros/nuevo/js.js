...
function vaciarCampos(){
		...
		$("#cconcepto").val("");
		$("#cunidad").val("");
		$("#cidcotizacionotros").val("");
		$("#cprecio").val("");
		$("#cimpuestos").val("");
		$("#ctotal").val("");
		$("#cestadopago").val("");
		$("#cestadofacturacion").val("");
		$("#cfactura").val("");
		$("#cestatus").val("");
	$("#cidcliente").focus();
}
...
function buscar (busqueda){
	location.href='../consultar/vista.php?link=vista&busqueda='+busqueda+'&n1=detallecotizacionesotros&n2=consultardetallecotizacionesotros';
}
