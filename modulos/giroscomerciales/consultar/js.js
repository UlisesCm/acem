...
function comprobarReglas(){
	...
	if(recuperarCookie("campoOrdenGirocomercial")!=null){
		campoOrden=recuperarCookie("campoOrdenGirocomercial");
	...
	if(recuperarCookie("cantidadamostrarGirocomercial")!=null){
		cantidadamostrar=recuperarCookie("cantidadamostrarGirocomercial");
	...
	if(recuperarCookie("ordenGirocomercial")=="asc"){
		orden="ASC"
		$('#asc').attr('checked', true);
		$('#desc').attr('checked', false);
	}else if(recuperarCookie("ordenGirocomercial")=="desc"){
		orden="DESC"
	...
	if(recuperarCookie("mostrarIdgirocomercialGirocomercial")=="si"){
		$('.Cidgirocomercial').show();
		$('#CheckIdgirocomercial').attr('checked', true);
	}else if(recuperarCookie("mostrarIdgirocomercialGirocomercial")=="no"){
		$('.Cidgirocomercial').hide();
		$('#CheckIdgirocomercial').attr('checked', false);
	}
	//Mostrar u Ocultar Nombre
	if(recuperarCookie("mostrarNombreGirocomercial")=="si"){
		$('.Cnombre').show();
		$('#CheckNombre').attr('checked', true);
	}else if(recuperarCookie("mostrarNombreGirocomercial")=="no"){
		$('.Cnombre').hide();
		$('#CheckNombre').attr('checked', false);
	}
	//Mostrar u Ocultar Composicion
	if(recuperarCookie("mostrarComposicionGirocomercial")=="si"){
		$('.Ccomposicion').show();
		$('#CheckComposicion').attr('checked', true);
	}
	if(recuperarCookie("mostrarComposicionGirocomercial")=="no"){
		$('.Ccomposicion').hide();
		$('#CheckComposicion').attr('checked', false);
	}
	
	//Elegir el tipo de vista
	if(recuperarCookie("tipoVistaGirocomercial")=="tabla"){
		$('.tipoLista').show();
		$('.tipoTabla').hide();
		tipoVista="tabla";
	}else{
	...
	$( ".tipoTabla" ).click(function() {
    	crearCookie("tipoVistaGirocomercial", "tabla");
		tipoVista="tabla";
		$(".tipoLista").show();
		$(".tipoTabla").hide();
	...
	$( ".tipoLista" ).click(function() {
    	crearCookie("tipoVistaGirocomercial", "lista");
		tipoVista="lista";
		$(".tipoLista").hide();
		$(".tipoTabla").show();
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
...
$(document).ready(function() {
	...
	$("#campoOrden").change(function(){
		...
		crearCookie("campoOrdenGirocomercial", campoOrden);
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
	});
	$("#cantidadamostrar").change(function(){
		cantidadamostrar = this.value;
		crearCookie("cantidadamostrarGirocomercial", cantidadamostrar);
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
	});
	$( "#asc" ).click(function() {
    	if ($( "#asc" ).is(':checked')){
			crearCookie("ordenGirocomercial", "asc");
			orden="ASC"
			load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
		}
	});
	$( "#desc" ).click(function() {
    	if ($( "#desc" ).is(':checked')){
			crearCookie("ordenGirocomercial", "desc");
			orden="DESC"
			load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
		}
	});
	$( "#CheckIdgirocomercial" ).click(function() {
    	if ($( "#CheckIdgirocomercial" ).is(':checked')){
			crearCookie("mostrarIdgirocomercialGirocomercial", "si");
			$('.Cidgirocomercial').show();
		}else{
			crearCookie("mostrarIdgirocomercialGirocomercial", "no");
			$('.Cidgirocomercial').hide();
		}	
	});
	$( "#CheckNombre" ).click(function() {
    	if ($( "#CheckNombre" ).is(':checked')){
			crearCookie("mostrarNombreGirocomercial", "si");
			$('.Cnombre').show();
		}else{
			crearCookie("mostrarNombreGirocomercial", "no");
			$('.Cnombre').hide();
		}	
	});
	$( "#CheckComposicion" ).click(function() {
    	if ($( "#CheckComposicion" ).is(':checked')){
			crearCookie("mostrarComposicionGirocomercial", "si");
			$('.Ccomposicion').show();
		}else{
			crearCookie("mostrarComposicionGirocomercial", "no");
			$('.Ccomposicion').hide();
		}
	});
