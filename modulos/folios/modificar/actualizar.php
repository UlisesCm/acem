  ...
  <body class="sidebar-mini <?php include("../../../componentes/skin.php");?>">
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Folio<small>Modificar registro</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Modificar folio</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['folios']['modificar']) or  !isset($_SESSION['permisos']['folios']['acceso'])){
	...
	/////FIN  DE PERMISOS////////
			...
			<?php include("../../../componentes/avisos.php");?>
          	...
          	<!-- Horizontal Form -->
            <div class="box box-info" style="border-color:#8c778c">
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
				...
				<div class="form-group ">
                    <label for="cfolioactual" class="col-sm-2 control-label">Folio actual:</label>
                    <div class="col-sm-2">
                    	<span id="Vfolioactual">
                        <input value="<?php echo $folioactual; ?>" name="folioactual" type="text" class="form-control" id="cfolioactual" />
            			<span class="textfieldMaxCharsMsg">Se ha superado el número máximo de caracteres.</span>
					<span class="textfieldMinCharsMsg">No se cumple el mínimo de caracteres requerido.</span>
						<span class="textfieldRequiredMsg">Se necesita un valor.</span>
					</span>
				...
				<div class="form-group ">
                  	<label for="casignacion" class="col-sm-2 control-label">Asignación:</label>
                    <div class="col-sm-2">
                    	<select id="casignacion" name="asignacion" class="form-control">
                        				<option value="REQUISICIONES" <?php 
											if ($asignacion=="REQUISICIONES"){
												echo 'selected="selected"';
											}
											 ?>>REQUISICIONES</option>
                                             
                                        <option value="COMPRAS" <?php 
											if ($asignacion=="COMPRAS"){
												echo 'selected="selected"';
											}
											 ?>>COMPRAS</option>
                                             
										<option value="SERVICIOS" <?php 
											if ($asignacion=="SERVICIOS"){
												echo 'selected="selected"';
											}
											 ?>>SERVICIOS</option>
										
										<option value="PRODUCTOS" <?php 
											if ($asignacion=="PRODUCTOS"){
												echo 'selected="selected"';
											}
											 ?>>PRODUCTOS</option>
                ...
                <div class="box-footer">
				  <input name="idfolio" type="hidden" id="cidfolio" value="<?php echo $id;?>"/>
                  <button type="button" class="btn btn-default" id="botonCancelar" onclick="vaciarCampos();">Limpiar</button>
                  <button type="button" class="btn btn-primary pull-right" id="botonGuardar"><i class="fa fa-save"></i>&nbsp;&nbsp;&nbsp;Guardar</button>
                </div><!-- /.box-footer -->
              </form>
              <div id="loading" class="overlay" style="display:none">
  					<i class="fa fa-cog fa-spin" style="color:#8c778c"></i>
			  </div>
...
var sprytextfield1 = new Spry.Widget.ValidationTextField("Vserie", "none", {validateOn:["blur"],  maxChars:10,  minChars:1});
				var sprytextfield2 = new Spry.Widget.ValidationTextField("Vfolioactual", "none", {validateOn:["blur"],  maxChars:10,  minChars:1});
				var sprytextfield1 = new Spry.Widget.ValidationTextField("Vserie", "none", {validateOn:["blur"],  maxChars:10,  minChars:1});
				var sprytextfield2 = new Spry.Widget.ValidationTextField("Vfolioactual", "none", {validateOn:["blur"],  maxChars:10,  minChars:1});
