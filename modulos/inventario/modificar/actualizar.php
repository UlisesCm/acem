	...
	/////FIN  DE PERMISOS////////
            ...
            <div class="box box-info" style="border-color:#005ebb">
              ...
              <div class="alert alert-warning alert-dismissable">
                    ...
                    Este módulo permite modificar las existencias, costos y ubicaciones de los productos. </br>
                    Modificar esta información hará que el historial de almacén del producto desaparezca de la base de datos, creando un registro limpio. </br> Asegurese de ingresar la información exacta de las existencias y el costo del producto.
              </div>
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
				...
				<input value="<?php echo $autoidproducto; ?>" name="autoidproducto" type="text" class="form-control" id="autoidproducto" />
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input value="<?php echo $existencia; ?>" name="existencia" type="text" class="form-control" id="cexistencia" onBlur="calcularSaldo();"/>
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input value="<?php echo $promedio; ?>" name="promedio" type="text" class="form-control" id="cpromedio" onBlur="calcularSaldo();"/>
