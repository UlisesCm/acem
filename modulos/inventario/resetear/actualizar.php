	...
	/////FIN  DE PERMISOS////////
            ...
            <div class="box box-info" style="border-color:#005ebb">
              ...
              <div class="alert alert-warning alert-dismissable">
                    ...
                    Este módulo permite eliminar los datos de inventario de los productos. Las existencias, ubicaciones, costos y el historial del kardex de cada uno de los productos serán eliminados.
              </div>
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
                ...
                <div class="box-footer">
                  <button type="button" class="btn btn-primary pull-right" id="botonGuardar"><i class="fa fa-save"></i>&nbsp;&nbsp;&nbsp;Resetear</button>
                </div><!-- /.box-footer -->
              </form>
