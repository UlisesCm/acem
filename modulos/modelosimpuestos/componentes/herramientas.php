          ...
          <ul class="dropdown-menu dropdown-menu-form" style="min-width:250px;;">
            ...
            <li><a>
            	<select id="campoOrden" class="form-control input-sm">
									<option value="idmodeloimpuestos">ID</option>
            ...
            <li><span class="titulo-herramientas">Mostrar / Ocultar campos</span></li>
				...
				<li><a><input id="CheckIdmodeloimpuestos" name="kidmodeloimpuestos" value="si" checked="checked" type="checkbox"/><label for="CheckIdmodeloimpuestos">&nbsp;&nbsp;ID</label></a></li>
			
				<li><a><input id="CheckNombre" name="knombre" value="si" checked="checked" type="checkbox"/><label for="CheckNombre">&nbsp;&nbsp;Nombre</label></a></li>
			
				<li><a><input id="CheckFechaactualizacion" name="kfechaactualizacion" value="si" checked="checked" type="checkbox"/><label for="CheckFechaactualizacion">&nbsp;&nbsp;Última actualización</label></a></li>
