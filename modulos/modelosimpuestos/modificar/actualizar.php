    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Modeloimpuestos<small>Modificar registro</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Modificar modeloimpuestos</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['modelosimpuestos']['modificar']) or  !isset($_SESSION['permisos']['modelosimpuestos']['acceso'])){
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input value="<?php echo $fechaactualizacion; ?>" name="fechaactualizacion" type="date" required class="form-control" id="cfechaactualizacion" />
                ...
                <div class="box-footer">
				  <input name="idmodeloimpuestos" type="hidden" id="cidmodeloimpuestos" value="<?php echo $id;?>"/>
