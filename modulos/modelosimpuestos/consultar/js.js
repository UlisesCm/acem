...
function comprobarReglas(){
	...
	if(recuperarCookie("campoOrdenModeloimpuestos")!=null){
		campoOrden=recuperarCookie("campoOrdenModeloimpuestos");
	...
	if(recuperarCookie("cantidadamostrarModeloimpuestos")!=null){
		cantidadamostrar=recuperarCookie("cantidadamostrarModeloimpuestos");
	...
	if(recuperarCookie("ordenModeloimpuestos")=="asc"){
		orden="ASC"
		$('#asc').attr('checked', true);
		$('#desc').attr('checked', false);
	}else if(recuperarCookie("ordenModeloimpuestos")=="desc"){
		orden="DESC"
	...
	if(recuperarCookie("mostrarIdmodeloimpuestosModeloimpuestos")=="si"){
		$('.Cidmodeloimpuestos').show();
		$('#CheckIdmodeloimpuestos').attr('checked', true);
	}else if(recuperarCookie("mostrarIdmodeloimpuestosModeloimpuestos")=="no"){
		$('.Cidmodeloimpuestos').hide();
		$('#CheckIdmodeloimpuestos').attr('checked', false);
	}
	//Mostrar u Ocultar Nombre
	if(recuperarCookie("mostrarNombreModeloimpuestos")=="si"){
		$('.Cnombre').show();
		$('#CheckNombre').attr('checked', true);
	}else if(recuperarCookie("mostrarNombreModeloimpuestos")=="no"){
		$('.Cnombre').hide();
		$('#CheckNombre').attr('checked', false);
	}
	//Mostrar u Ocultar Fechaactualizacion
	if(recuperarCookie("mostrarFechaactualizacionModeloimpuestos")=="si"){
		$('.Cfechaactualizacion').show();
		$('#CheckFechaactualizacion').attr('checked', true);
	}else if(recuperarCookie("mostrarFechaactualizacionModeloimpuestos")=="no"){
		$('.Cfechaactualizacion').hide();
		$('#CheckFechaactualizacion').attr('checked', false);
	}
	//Mostrar u Ocultar Composicion
	if(recuperarCookie("mostrarComposicionModeloimpuestos")=="si"){
		$('.Ccomposicion').show();
		$('#CheckComposicion').attr('checked', true);
	}
	if(recuperarCookie("mostrarComposicionModeloimpuestos")=="no"){
		$('.Ccomposicion').hide();
		$('#CheckComposicion').attr('checked', false);
	}
	
	//Elegir el tipo de vista
	if(recuperarCookie("tipoVistaModeloimpuestos")=="tabla"){
		$('.tipoLista').show();
		$('.tipoTabla').hide();
		tipoVista="tabla";
	}else{
	...
	$( ".tipoTabla" ).click(function() {
    	crearCookie("tipoVistaModeloimpuestos", "tabla");
		tipoVista="tabla";
		$(".tipoLista").show();
		$(".tipoTabla").hide();
	...
	$( ".tipoLista" ).click(function() {
    	crearCookie("tipoVistaModeloimpuestos", "lista");
		tipoVista="lista";
		$(".tipoLista").hide();
		$(".tipoTabla").show();
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
...
$(document).ready(function() {
	...
	$("#campoOrden").change(function(){
		...
		crearCookie("campoOrdenModeloimpuestos", campoOrden);
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
	});
	$("#cantidadamostrar").change(function(){
		cantidadamostrar = this.value;
		crearCookie("cantidadamostrarModeloimpuestos", cantidadamostrar);
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
	});
	$( "#asc" ).click(function() {
    	if ($( "#asc" ).is(':checked')){
			crearCookie("ordenModeloimpuestos", "asc");
			orden="ASC"
			load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
		}
	});
	$( "#desc" ).click(function() {
    	if ($( "#desc" ).is(':checked')){
			crearCookie("ordenModeloimpuestos", "desc");
			orden="DESC"
			load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
		}
	});
	$( "#CheckIdmodeloimpuestos" ).click(function() {
    	if ($( "#CheckIdmodeloimpuestos" ).is(':checked')){
			crearCookie("mostrarIdmodeloimpuestosModeloimpuestos", "si");
			$('.Cidmodeloimpuestos').show();
		}else{
			crearCookie("mostrarIdmodeloimpuestosModeloimpuestos", "no");
			$('.Cidmodeloimpuestos').hide();
		}	
	});
	$( "#CheckNombre" ).click(function() {
    	if ($( "#CheckNombre" ).is(':checked')){
			crearCookie("mostrarNombreModeloimpuestos", "si");
			$('.Cnombre').show();
		}else{
			crearCookie("mostrarNombreModeloimpuestos", "no");
			$('.Cnombre').hide();
		}	
	});
	$( "#CheckFechaactualizacion" ).click(function() {
    	if ($( "#CheckFechaactualizacion" ).is(':checked')){
			crearCookie("mostrarFechaactualizacionModeloimpuestos", "si");
			$('.Cfechaactualizacion').show();
		}else{
			crearCookie("mostrarFechaactualizacionModeloimpuestos", "no");
			$('.Cfechaactualizacion').hide();
		}	
	});
	$( "#CheckComposicion" ).click(function() {
    	if ($( "#CheckComposicion" ).is(':checked')){
			crearCookie("mostrarComposicionModeloimpuestos", "si");
			$('.Ccomposicion').show();
		}else{
			crearCookie("mostrarComposicionModeloimpuestos", "no");
			$('.Ccomposicion').hide();
		}
	});
