		...
		<ul>
			...
			<li>
				<div class="tituloMenu">
					<div id="labelMenu">modelosimpuestos</div>
				</div>
			</li>
			<?php
			/////PERMISOS////////////////
			...
			<li>
				...
				<div id="labelMenu">Nuevo modeloimpuestos</div>
				</a>
			</li>
			<?php }?>
			...
			<li>
				...
				<div id="labelMenu">Consultar modelosimpuestos</div>
				</a>
			</li>
			<?php }?>
			<?php
			...
			<li>
				...
				<div id="labelMenu">Papelera de modelosimpuestos</div>
				</a>
			</li>
			<?php }?>
