          ...
          <ul class="dropdown-menu dropdown-menu-form" style="min-width:250px;;">
            ...
            <li><a>
            	<select id="campoOrden" class="form-control input-sm">
									...
									<option value="nivelcalidad">Nivel de calidad</option>
									<option value="nivelexistencia">Nivel de existencia</option>
									<option value="tiemporespuesta">Tiempo de respuesta en dias</option>
                </select>
                </a>
    		</li>
            ...
            <li><span class="titulo-herramientas">Mostrar / Ocultar campos</span></li>
				...
				<li><a><input id="CheckNivelcalidad" name="knivelcalidad" value="si" checked="checked" type="checkbox"/><label for="CheckNivelcalidad">&nbsp;&nbsp;Nivel de calidad</label></a></li>
			
				<li><a><input id="CheckNivelexistencia" name="knivelexistencia" value="si" checked="checked" type="checkbox"/><label for="CheckNivelexistencia">&nbsp;&nbsp;Nivel de existencia</label></a></li>
			
				<li><a><input id="CheckTiemporespuesta" name="ktiemporespuesta" value="si" checked="checked" type="checkbox"/><label for="CheckTiemporespuesta">&nbsp;&nbsp;Tiempo de respuesta en días</label></a></li>
