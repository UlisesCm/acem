    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Proveedor<small>Modificar registro</small>
          </h1>
          <ol class="breadcrumb">
            ...
            <div class="box box-info" style="border-color:#e7ec11">
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-1">
                    	<select id="cnivelexistencia" name="nivelexistencia" class="form-control">
										<option value="1" <?php 
											if ($nivelexistencia=="1"){
												echo 'selected="selected"';
											}
											 ?>>1</option>
										
										<option value="2" <?php 
											if ($nivelexistencia=="2"){
												echo 'selected="selected"';
											}
											 ?>>2</option>
										
										<option value="3" <?php 
											if ($nivelexistencia=="3"){
												echo 'selected="selected"';
											}
											 ?>>3</option>
										
										<option value="4" <?php 
											if ($nivelexistencia=="4"){
												echo 'selected="selected"';
											}
											 ?>>4</option>
										
										<option value="5" <?php 
											if ($nivelexistencia=="5"){
												echo 'selected="selected"';
											}
											 ?>>5</option>
                ...
                <div class="form-group ">
                    ...
                    <div class="col-sm-5">
                    	<select id="ctipoprontopago" name="tipoprontopago" class="form-control">
                            ...
                            <option value="FACTURACION" <?php 
								if ($tipoprontopago=="FACTURACION"){
									echo 'selected="selected"';
								}
								 ?>>PRONTO PAGO A PARTIR DE LA FACTURACION</option>
							
							<option value="RECEPCION" <?php 
								if ($tipoprontopago=="RECEPCION"){
									echo 'selected="selected"';
								}
								 ?>>PRONTO PAGO A PARTIR DE LA RECEPCIO</option>
                ...
                <div class="form-group ">
                    ...
                    <div class="col-sm-2">
                        <input value="<?php echo $prontopagofactura?>" name="prontopagofactura" type="text" class="form-control" id="cprontopagofactura" />
            		</div>
                </div>
                ...
                <div class="form-group ">
                    ...
                    <div class="col-sm-2">
                        <input value="<?php echo $prontopagorecepcion?>" name="prontopagorecepcion" type="text" class="form-control" id="cprontopagorecepcion" />
            		</div>
                </div>
