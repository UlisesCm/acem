...
if($validacion){
	$resultado=$Oproveedor->guardar($nombre,$rfc,$nivelcalidad,$nivelexistencia,$tiemporespuesta,$tipoprontopago,$prontopagofactura,$prontopagorecepcion,$email,$estatus);
	if($resultado=="exito"){
