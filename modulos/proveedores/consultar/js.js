...
function comprobarReglas(){
	...
	if(recuperarCookie("campoOrdenProveedor")!=null){
		campoOrden=recuperarCookie("campoOrdenProveedor");
	...
	if(recuperarCookie("cantidadamostrarProveedor")!=null){
		cantidadamostrar=recuperarCookie("cantidadamostrarProveedor");
	...
	if(recuperarCookie("ordenProveedor")=="asc"){
		orden="ASC"
		$('#asc').attr('checked', true);
		$('#desc').attr('checked', false);
	}else if(recuperarCookie("ordenProveedor")=="desc"){
		orden="DESC"
	...
	if(recuperarCookie("mostrarNombreProveedor")=="si"){
		$('.Cnombre').show();
		$('#CheckNombre').attr('checked', true);
	}else if(recuperarCookie("mostrarNombreProveedor")=="no"){
		$('.Cnombre').hide();
		$('#CheckNombre').attr('checked', false);
	}
	//Mostrar u Ocultar Nivelcalidad
	if(recuperarCookie("mostrarNivelcalidadProveedor")=="si"){
		$('.Cnivelcalidad').show();
		$('#CheckNivelcalidad').attr('checked', true);
	}else if(recuperarCookie("mostrarNivelcalidadProveedor")=="no"){
		$('.Cnivelcalidad').hide();
		$('#CheckNivelcalidad').attr('checked', false);
	}
	//Mostrar u Ocultar Nivelexistencia
	if(recuperarCookie("mostrarNivelexistenciaProveedor")=="si"){
		$('.Cnivelexistencia').show();
		$('#CheckNivelexistencia').attr('checked', true);
	}else if(recuperarCookie("mostrarNivelexistenciaProveedor")=="no"){
		$('.Cnivelexistencia').hide();
		$('#CheckNivelexistencia').attr('checked', false);
	}
	//Mostrar u Ocultar Tiemporespuesta
	if(recuperarCookie("mostrarTiemporespuestaProveedor")=="si"){
		$('.Ctiemporespuesta').show();
		$('#CheckTiemporespuesta').attr('checked', true);
	}else if(recuperarCookie("mostrarTiemporespuestaProveedor")=="no"){
		$('.Ctiemporespuesta').hide();
		$('#CheckTiemporespuesta').attr('checked', false);
	}
	//Mostrar u Ocultar Composicion
	if(recuperarCookie("mostrarComposicionProveedor")=="si"){
		$('.Ccomposicion').show();
		$('#CheckComposicion').attr('checked', true);
	}
	if(recuperarCookie("mostrarComposicionProveedor")=="no"){
		$('.Ccomposicion').hide();
		$('#CheckComposicion').attr('checked', false);
	}
	
	//Elegir el tipo de vista
	if(recuperarCookie("tipoVistaProveedor")=="tabla"){
		$('.tipoLista').show();
		$('.tipoTabla').hide();
		tipoVista="tabla";
	}else{
	...
	$( ".tipoTabla" ).click(function() {
    	crearCookie("tipoVistaProveedor", "tabla");
		tipoVista="tabla";
		$(".tipoLista").show();
		$(".tipoTabla").hide();
	...
	$( ".tipoLista" ).click(function() {
    	crearCookie("tipoVistaProveedor", "lista");
		tipoVista="lista";
		$(".tipoLista").hide();
		$(".tipoTabla").show();
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
...
$(document).ready(function() {
	...
	$("#campoOrden").change(function(){
		...
		crearCookie("campoOrdenProveedor", campoOrden);
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
	});
	$("#cantidadamostrar").change(function(){
		cantidadamostrar = this.value;
		crearCookie("cantidadamostrarProveedor", cantidadamostrar);
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
	});
	$( "#asc" ).click(function() {
    	if ($( "#asc" ).is(':checked')){
			crearCookie("ordenProveedor", "asc");
			orden="ASC"
			load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
		}
	});
	$( "#desc" ).click(function() {
    	if ($( "#desc" ).is(':checked')){
			crearCookie("ordenProveedor", "desc");
			orden="DESC"
			load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
		}
	});
	$( "#CheckNombre" ).click(function() {
    	if ($( "#CheckNombre" ).is(':checked')){
			crearCookie("mostrarNombreProveedor", "si");
			$('.Cnombre').show();
		}else{
			crearCookie("mostrarNombreProveedor", "no");
			$('.Cnombre').hide();
		}	
	});
	$( "#CheckNivelcalidad" ).click(function() {
    	if ($( "#CheckNivelcalidad" ).is(':checked')){
			crearCookie("mostrarNivelcalidadProveedor", "si");
			$('.Cnivelcalidad').show();
		}else{
			crearCookie("mostrarNivelcalidadProveedor", "no");
			$('.Cnivelcalidad').hide();
		}	
	});
	$( "#CheckNivelexistencia" ).click(function() {
    	if ($( "#CheckNivelexistencia" ).is(':checked')){
			crearCookie("mostrarNivelexistenciaProveedor", "si");
			$('.Cnivelexistencia').show();
		}else{
			crearCookie("mostrarNivelexistenciaProveedor", "no");
			$('.Cnivelexistencia').hide();
		}	
	});
	$( "#CheckTiemporespuesta" ).click(function() {
    	if ($( "#CheckTiemporespuesta" ).is(':checked')){
			crearCookie("mostrarTiemporespuestaProveedor", "si");
			$('.Ctiemporespuesta').show();
		}else{
			crearCookie("mostrarTiemporespuestaProveedor", "no");
			$('.Ctiemporespuesta').hide();
		}	
	});
	$( "#CheckComposicion" ).click(function() {
    	if ($( "#CheckComposicion" ).is(':checked')){
			crearCookie("mostrarComposicionProveedor", "si");
			$('.Ccomposicion').show();
		}else{
			crearCookie("mostrarComposicionProveedor", "no");
			$('.Ccomposicion').hide();
		}
	});
