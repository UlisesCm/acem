...
if($validacion){
	...
	$resultado=$Ocotizacionproducto->guardar($clienteSeleccionado,$domicilioSeleccionado,$cliente,$idgirocomercial,$tipovialidad,$calle,$noexterior,$nointerior,$colonia,$cp,$idzona,$nombrecomercial,$serie,$folio,$fecha,$hora,$estadopago,$estadofacturacion,$tipo,$subtotal,$impuestos,$total,$costodeventa,$utilidad,$observaciones,$idcliente,$idusuario,$idempleado,$idsucursal,$iddomicilio,$enviaradomicilio,$fechaentrega,$horaentregainicio,$horaentregafin,$prioridad,$coordenadas,$ciudad, $estado, $referencia,$observacionesdomicilio,$estadoentrega,$estatus,$lista,$dividirventa,$montodivision,$serieotros,$foliootros,$fechaotros,$tipootros,$montootros,$observacionesotros,$listaOtros,$impuestosotros,$subtotalotros,$idmodeloimpuestosotros,$estatusotros);
	if($resultado=="exito"){
