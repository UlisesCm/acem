...
<script>var estiloDescripcion="style='padding-bottom:3pt;'";</script>
             ...
             <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-info" style="border-color:#0c63ba">
                        <div class="box-header with-border">
                            <h3 class="box-title">Lista de productos</h3> <div style="display:none">(TICKET: <span class="numticket"></span>)</div>
                                ...
                                <table id="tablaSalida" class="table table-hover table-bordered">
                                    <thead>
                                        <tr style="background:#F3F3F3; color:#666; height:30px; border:1px" align="center">
                                            ...
                                            <td width="100">Precio Unitario</td>
                    ...
                    <!-- Fina Tabla --> 
                        ...
                        <div class="box-footer">
                            <div class="row filaEspecial">  
                               <div class="form-group ">
                                <label for="cobservaciones" class="col-sm-2" >Observaciones:</label>
                                <div class="col-sm-12">
