...
if($busqueda == ""){
	...
	if($idruta!=""){
		...
		if($filtroavanzado=="Si"){
			$resultado=$Ocotizacionproducto->mostrarA($campoOrden, $orden, $inicial, $cantidadamostrar, $busqueda, $papelera, $idcliente,$iddomicilio,$idzona,$idsucursal,$tipo,$filtrarfecha,$fechainicio,$fechafin);
		}
...
if ($tipoVista=="tabla"){ // Si se ha elegido el tipo tabla ?>
	<div class="box-body table-responsive no-padding"> <!-- /.box-body -->
    	<table class="table table-hover table-bordered">
        	<tr>
				...
				<th class="Ccostodeventa">Costo de venta</th>
				...
				<th class="Choraentregainicio">Hora entrega inicio</th>
				<th class="Choraentregafin">Hora entrega fin</th>
	...
	while ($filas=mysqli_fetch_array($resultado)) { ?>
      		<tr id="iregistro<?php echo $filas['idcotizacionproducto'] ?>">
				...
				<td class="Ccostodeventa"><?php echo $filas['costodeventa']; ?></td>
				...
				?>
				<td class="Cfechaentrega"><?php echo $nuevaFecha; ?></td>
				<td class="Choraentregainicio"><?php echo $filas['horaentregainicio']; ?></td>
				<td class="Choraentregafin"><?php echo $filas['horaentregafin']; ?></td>
