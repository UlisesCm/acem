...
if($validacion){
	$resultado=$Ocotizacionotro->guardar($serie,$folio,$fecha,$tipo,$monto,$idcliente,$idsucursal,$idempleado,$observaciones,$lista,$impuestos,$subtotal,$idmodeloimpuestos,$estatus);
	if($resultado=="exito"){
