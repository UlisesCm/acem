		...
		<ul>
			...
			<li>
				<div class="tituloMenu">
					<div id="labelMenu">cotizacionesotros</div>
				</div>
			</li>
			<?php
			/////PERMISOS////////////////
			...
			<li>
				...
				<div id="labelMenu">Nuevo cotizacionotro</div>
				</a>
			</li>
			<?php }?>
			...
			<li>
				...
				<div id="labelMenu">Consultar cotizacionesotros</div>
				</a>
			</li>
			<?php }?>
			<?php
			...
			<li>
				...
				<div id="labelMenu">Papelera de cotizacionesotros</div>
				</a>
			</li>
			<?php }?>
