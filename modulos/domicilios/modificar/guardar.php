...
if($validacion){
	$resultado=$Odomicilio->actualizar($idcliente,$tipovialidad,$calle,$noexterior,$nointerior,$nombrecomercial,$colonia,$cp,$ciudad,$estado,$idzona,$coordenadas,$referencia,$observaciones,$idsucursal,$idgirocomercial,$validardosis,$idempleado,$contactos,$estatus, $iddomicilio);
	if($resultado=="exito"){
