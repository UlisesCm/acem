		...
		<ul>
			...
			<li>
				<div class="tituloMenu">
					<div id="labelMenu">domicilios</div>
				</div>
			</li>
			<?php
			/////PERMISOS////////////////
			...
			<li>
				...
				<div id="labelMenu">Nuevo domicilio</div>
				</a>
			</li>
			<?php }?>
			...
			<li>
				...
				<div id="labelMenu">Consultar domicilios</div>
				</a>
			</li>
			<?php }?>
			<?php
			...
			<li>
				...
				<div id="labelMenu">Papelera de domicilios</div>
				</a>
			</li>
			<?php }?>
