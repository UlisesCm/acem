...
orden="DESC";
campoOrden="idasignacionvehicular";
iniciar="0";
cantidadamostrar="20";
paginacion=0;
...
function comprobarReglas(){
	...
	if(recuperarCookie("campoOrdenAsignacionvehicular")!=null){
		campoOrden=recuperarCookie("campoOrdenAsignacionvehicular");
	...
	if(recuperarCookie("cantidadamostrarAsignacionvehicular")!=null){
		cantidadamostrar=recuperarCookie("cantidadamostrarAsignacionvehicular");
	...
	if(recuperarCookie("ordenAsignacionvehicular")=="asc"){
		orden="ASC"
		$('#asc').attr('checked', true);
		$('#desc').attr('checked', false);
	}else if(recuperarCookie("ordenAsignacionvehicular")=="desc"){
		orden="DESC"
	...
	if(recuperarCookie("mostrarFechaAsignacionvehicular")=="si"){
		$('.Cfecha').show();
		$('#CheckFecha').attr('checked', true);
	}else if(recuperarCookie("mostrarFechaAsignacionvehicular")=="no"){
		$('.Cfecha').hide();
		$('#CheckFecha').attr('checked', false);
	}
	//Mostrar u Ocultar Idempleado
	if(recuperarCookie("mostrarIdempleadoAsignacionvehicular")=="si"){
		$('.Cidempleado').show();
		$('#CheckIdempleado').attr('checked', true);
	}else if(recuperarCookie("mostrarIdempleadoAsignacionvehicular")=="no"){
		$('.Cidempleado').hide();
		$('#CheckIdempleado').attr('checked', false);
	}
	//Mostrar u Ocultar Idvehiculo
	if(recuperarCookie("mostrarIdvehiculoAsignacionvehicular")=="si"){
		$('.Cidvehiculo').show();
		$('#CheckIdvehiculo').attr('checked', true);
	}else if(recuperarCookie("mostrarIdvehiculoAsignacionvehicular")=="no"){
		$('.Cidvehiculo').hide();
		$('#CheckIdvehiculo').attr('checked', false);
	}
	//Mostrar u Ocultar Observaciones
	if(recuperarCookie("mostrarObservacionesAsignacionvehicular")=="si"){
		$('.Cobservaciones').show();
		$('#CheckObservaciones').attr('checked', true);
	}else if(recuperarCookie("mostrarObservacionesAsignacionvehicular")=="no"){
		$('.Cobservaciones').hide();
		$('#CheckObservaciones').attr('checked', false);
	}
	//Mostrar u Ocultar Composicion
	if(recuperarCookie("mostrarComposicionAsignacionvehicular")=="si"){
		$('.Ccomposicion').show();
		$('#CheckComposicion').attr('checked', true);
	}
	if(recuperarCookie("mostrarComposicionAsignacionvehicular")=="no"){
		$('.Ccomposicion').hide();
		$('#CheckComposicion').attr('checked', false);
	}
	
	//Elegir el tipo de vista
	if(recuperarCookie("tipoVistaAsignacionvehicular")=="tabla"){
		$('.tipoLista').show();
		$('.tipoTabla').hide();
		tipoVista="tabla";
	}else{
	...
	$( ".tipoTabla" ).click(function() {
    	crearCookie("tipoVistaAsignacionvehicular", "tabla");
		tipoVista="tabla";
		$(".tipoLista").show();
		$(".tipoTabla").hide();
	...
	$( ".tipoLista" ).click(function() {
    	crearCookie("tipoVistaAsignacionvehicular", "lista");
		tipoVista="lista";
		$(".tipoLista").hide();
		$(".tipoTabla").show();
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
...
$(document).ready(function() {
	...
	$("#campoOrden").change(function(){
		...
		crearCookie("campoOrdenAsignacionvehicular", campoOrden);
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
	});
	$("#cantidadamostrar").change(function(){
		cantidadamostrar = this.value;
		crearCookie("cantidadamostrarAsignacionvehicular", cantidadamostrar);
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
	});
	$( "#asc" ).click(function() {
    	if ($( "#asc" ).is(':checked')){
			crearCookie("ordenAsignacionvehicular", "asc");
			orden="ASC"
			load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
		}
	});
	$( "#desc" ).click(function() {
    	if ($( "#desc" ).is(':checked')){
			crearCookie("ordenAsignacionvehicular", "desc");
			orden="DESC"
			load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
		}
	});
	$( "#CheckFecha" ).click(function() {
    	if ($( "#CheckFecha" ).is(':checked')){
			crearCookie("mostrarFechaAsignacionvehicular", "si");
			$('.Cfecha').show();
		}else{
			crearCookie("mostrarFechaAsignacionvehicular", "no");
			$('.Cfecha').hide();
		}	
	});
	$( "#CheckIdempleado" ).click(function() {
    	if ($( "#CheckIdempleado" ).is(':checked')){
			crearCookie("mostrarIdempleadoAsignacionvehicular", "si");
			$('.Cidempleado').show();
		}else{
			crearCookie("mostrarIdempleadoAsignacionvehicular", "no");
			$('.Cidempleado').hide();
		}	
	});
	$( "#CheckIdvehiculo" ).click(function() {
    	if ($( "#CheckIdvehiculo" ).is(':checked')){
			crearCookie("mostrarIdvehiculoAsignacionvehicular", "si");
			$('.Cidvehiculo').show();
		}else{
			crearCookie("mostrarIdvehiculoAsignacionvehicular", "no");
			$('.Cidvehiculo').hide();
		}	
	});
	$( "#CheckObservaciones" ).click(function() {
    	if ($( "#CheckObservaciones" ).is(':checked')){
			crearCookie("mostrarObservacionesAsignacionvehicular", "si");
			$('.Cobservaciones').show();
		}else{
			crearCookie("mostrarObservacionesAsignacionvehicular", "no");
			$('.Cobservaciones').hide();
		}	
	});
	$( "#CheckComposicion" ).click(function() {
    	if ($( "#CheckComposicion" ).is(':checked')){
			crearCookie("mostrarComposicionAsignacionvehicular", "si");
			$('.Ccomposicion').show();
		}else{
			crearCookie("mostrarComposicionAsignacionvehicular", "no");
			$('.Ccomposicion').hide();
		}
	});
