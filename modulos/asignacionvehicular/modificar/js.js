...
$(document).ready(function() {
	...
	llenarSelectVehiculo(idvehiculoSeleccionado,"");
...
function buscar (busqueda){
	location.href='../consultar/vista.php?link=vista&busqueda='+busqueda+'&n1=asignacionvehicular&n2=consultarasignacionvehicular';
}
...
function llenarSelectVehiculo(seleccionado,condicion){
