    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Asignacionvehicular<small>Modificar registro</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Modificar asignacionvehicular</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['asignacionvehicular']['modificar']) or  !isset($_SESSION['permisos']['asignacionvehicular']['acceso'])){
            ...
            <div class="box box-info" style="border-color:#bd3752">
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
                ...
                <div class="box-footer">
				  <input name="idasignacionvehicular" type="hidden" id="cidasignacionvehicular" value="<?php echo $id;?>"/>
