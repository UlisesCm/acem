...
{
function GeneradorPdf($nombreExamen, $nombreAlumno, $calificacionFinal, $idavancecurso, $nombreDocente, $nombrePDF){
...
// $tamanocontenido=-88;
  try {
   ...
   $footer = Footer($nombreDocente); // esta en el index el diseño   -> diseño del footer
    ...
    $mpdf->Output('../../../empresas/modulalite/archivosSubidos/cursos/examenes/'.$nombrePDF, 'F');
    return $mpdf->Output('examen.pdf','I');
